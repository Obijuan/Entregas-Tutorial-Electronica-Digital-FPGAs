{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "2dbd75a6-ce00-4b61-b7ff-80fc0da10424",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "52d36e73-459f-436a-90bb-7159f08599f2",
          "type": "basic.input",
          "data": {
            "name": "",
            "range": "[0:2]",
        ...
        {
          "id": "44c7c4ce-b7a3-4fda-9b3d-c864e29e4a8f",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "089c7a47-3cb9-4e04-a932-04fd8e11332b",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "00  // 000  D Stop\n0B  // 001  D Izq\n0C  // 010  D Der\n0E  // 011  D Avanza\n00  // 100  I stop\n07  // 101  I R Izq\n08  // 110  I R Der\n0D  // 111  I Atras",
        ...
        {
          "id": "f76cab90-ef83-45a5-931c-ba23c1132c21",
        ...
        {
          "id": "a67f6f7f-7383-4465-bfd5-b8955506d94d",
        ...
        {
          "id": "c3a1637f-4d3c-449d-94cd-37c4e5517844",
          "type": "basic.info",
          "data": {
            "info": "Modo",
            "readonly": true
        ...
        {
          "id": "bb6b9c5f-8211-4a85-b4c7-bfe78af2f243",
          "type": "basic.info",
          "data": {
            "info": "Pizq\nPder",
            "readonly": true
      ...
      "wires": [
        {
          "source": {
            "block": "f76cab90-ef83-45a5-931c-ba23c1132c21",
            "port": "fcbbbbd8-842e-4302-88fd-00187a8e974d"
          },
          "target": {
            "block": "2dbd75a6-ce00-4b61-b7ff-80fc0da10424",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "44c7c4ce-b7a3-4fda-9b3d-c864e29e4a8f",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "a67f6f7f-7383-4465-bfd5-b8955506d94d",
        ...
        {
          "source": {
            "block": "52d36e73-459f-436a-90bb-7159f08599f2",
            "port": "out"
          },
          "target": {
            "block": "a67f6f7f-7383-4465-bfd5-b8955506d94d",
        ...
        {
          "source": {
            "block": "089c7a47-3cb9-4e04-a932-04fd8e11332b",
            "port": "memory-out"
          },
          "target": {
            "block": "a67f6f7f-7383-4465-bfd5-b8955506d94d",
