    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n\n## Tutorial 30 :\n\n### Ejercicio 30.4: (5 Bitpoints). Control de franky a través de bluetooth y APP Inventor\n\nDiseñar un circuito para controlar a **Franky** a través del bluetooth y una APP diseñada \ncon la aplicación APP INVENTOR. \nHay tres  comandos de posición: **q**,**w** y **e** que hacen que los ojos de franky apunten en tres  \ndirecciones: izquierda, centro y derecha\n\nMediante la **barra espaciadora** activamos el **modo de disparo**, haciendo parpadear sus  \nojos a la frecuencia de **10Hz** y emitiendo pitidos cortos de **1Khz** con una cadencia  \nde **10Hz**. Si mientras está disparando apretamos nuevamente la barra espaciadora dejará de  \nhacerlo.  \n",
            "readonly": true
          },
          "position": {
            "x": -4416,
