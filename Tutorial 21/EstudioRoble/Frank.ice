{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "610a3215-da21-4240-a727-cdf8e76a2c94",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "28591bba-a9cd-46a4-85d5-1fd8409ddb29",
          "type": "basic.output",
          "data": {
            "name": "OjOs",
            "pins": [
        ...
        {
          "id": "81eed544-421d-46ff-8822-890fe075eac8",
          "type": "basic.input",
          "data": {
            "name": "Disparar",
            "pins": [
        ...
        {
          "id": "7d0d59f0-c0b9-4575-b386-d6e818364d82",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "fd0d2575-3110-4351-a6fa-7d910d48eb2a",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "7dcf0ac1-8f9d-4ef6-89b3-d1ad90f52a69",
          "type": "basic.input",
          "data": {
            "name": "Cuello",
            "pins": [
        ...
        {
          "id": "f6ff2b48-95c7-4f99-99f7-b5214c30d307",
          "type": "basic.constant",
          "data": {
            "name": "freq",
            "value": "10",
        ...
        {
          "id": "54ad50a1-6253-4076-8523-6f2d4eff8046",
          "type": "13e341abf5fbd23916586973ef9c177fac67f5f2",
          "position": {
            "x": 376,
            "y": 256
          },
        ...
        {
          "id": "ebebbdc9-ac22-45ef-bc1e-923ec2e6bba4",
          "type": "basic.info",
          "data": {
            "info": "## 21.3\n",
            "readonly": true
        ...
        {
          "id": "b60826bf-9613-4ba1-9a9d-db0687c66df7",
        ...
        {
          "id": "7ad5a7fe-15df-416b-b7d9-83ddefd53c23",
      ...
      "wires": [
        {
          "source": {
            "block": "54ad50a1-6253-4076-8523-6f2d4eff8046",
            "port": "e62473bd-3a9e-4bac-8f48-377a782fd72d"
          },
          "target": {
            "block": "28591bba-a9cd-46a4-85d5-1fd8409ddb29",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "b60826bf-9613-4ba1-9a9d-db0687c66df7",
            "port": "dd28d456-e7a5-40ee-be2f-be3b0c65def9"
          },
          "target": {
            "block": "fd0d2575-3110-4351-a6fa-7d910d48eb2a",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "7dcf0ac1-8f9d-4ef6-89b3-d1ad90f52a69",
            "port": "out"
          },
          "target": {
            "block": "b60826bf-9613-4ba1-9a9d-db0687c66df7",
        ...
        {
          "source": {
            "block": "81eed544-421d-46ff-8822-890fe075eac8",
            "port": "out"
          },
          "target": {
            "block": "54ad50a1-6253-4076-8523-6f2d4eff8046",
            "port": "49481485-e88a-4be0-9e48-fc635a992531"
          }
        },
        {
          "source": {
            "block": "7ad5a7fe-15df-416b-b7d9-83ddefd53c23",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "54ad50a1-6253-4076-8523-6f2d4eff8046",
            "port": "7234f5ca-e815-4ae4-876f-9b70448e4959"
          }
        },
        {
          "source": {
            "block": "f6ff2b48-95c7-4f99-99f7-b5214c30d307",
            "port": "constant-out"
          },
          "target": {
            "block": "7ad5a7fe-15df-416b-b7d9-83ddefd53c23",
        ...
        },
        {
          ...
          "target": {
            "block": "7d0d59f0-c0b9-4575-b386-d6e818364d82",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "610a3215-da21-4240-a727-cdf8e76a2c94",
            "port": "in"
          }
        }
      ]
  ...
  "dependencies": {
    "13e341abf5fbd23916586973ef9c177fac67f5f2": {
      "package": {
        "name": "Estudio Roble",
        "version": "1",
        "description": "Un bloque con el logo",
        "author": "A",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "7234f5ca-e815-4ae4-876f-9b70448e4959",
              "type": "basic.input",
              "data": {
                "name": "",
                "clock": false
            ...
            {
              "id": "e62473bd-3a9e-4bac-8f48-377a782fd72d",
              "type": "basic.output",
              "data": {
                "name": ""
              },
            ...
            {
              "id": "49481485-e88a-4be0-9e48-fc635a992531",
              "type": "basic.input",
              "data": {
                "name": "",
                "clock": false
            ...
            {
              "id": "b96947f9-2973-4279-9c19-ef9696c6a684",
          ...
          "wires": [
            {
              "source": {
                "block": "7234f5ca-e815-4ae4-876f-9b70448e4959",
                "port": "out"
              },
              "target": {
                "block": "b96947f9-2973-4279-9c19-ef9696c6a684",
                "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
              }
            },
            {
              "source": {
                "block": "49481485-e88a-4be0-9e48-fc635a992531",
                "port": "out"
              },
              "target": {
                "block": "b96947f9-2973-4279-9c19-ef9696c6a684",
            ...
            },
            {
              ...
              "target": {
                "block": "e62473bd-3a9e-4bac-8f48-377a782fd72d",
                "port": "in"
              }
            }
          ]
