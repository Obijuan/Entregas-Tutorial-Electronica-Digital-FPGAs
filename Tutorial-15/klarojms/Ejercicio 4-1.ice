{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "318e54b2-3d50-40e2-a615-784532451871",
          "type": "basic.output",
          "data": {
            "name": "Motor_left",
            "pins": [
        ...
        {
          "id": "ac30d327-689d-431d-98f8-8fd0293c6d16",
          "type": "basic.output",
          "data": {
            "name": "Motor_right",
            "pins": [
        ...
        {
          "id": "0e664415-eefd-437d-891e-cd43e9f751e3",
        ...
        {
          "id": "1e5f3b1d-b9e7-474a-aff2-826df1bd2d51",
        ...
        {
          "id": "ef5c4f9f-a4ad-45fe-b63e-0b0b0d07cbb8",
        ...
        {
          "id": "4580ec15-7460-4fc3-9686-8405ea6c2e83",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "9024c69b-70a5-4b82-8c97-d10222452a4c",
          "type": "f97d11b78f83014e3f27ffb06850087e01ea5690",
          "position": {
            "x": 2112,
            "y": -448
        ...
        {
          "id": "840b79b1-0733-49dd-94ef-c2b48fb5e686",
          "type": "basic.info",
          "data": {
            "info": "**Rueda Derecha**",
            "readonly": true
        ...
        {
          "id": "e06d3fc2-5778-4518-b109-110a660636bf",
        ...
        {
          "id": "44f1d6ea-4a48-4505-b3f4-1d3adec25aa6",
          "type": "basic.code",
          "data": {
            "code": "reg onL;\r\nreg dirL;\r\nreg onR;\r\nreg dirR;\r\n\r\nalways @(posedge clk) begin\r\n  case (adr)\r\n  3'b000: begin  // Adelante\r\n    onL = 1; dirL = 0;\r\n    onR = 1; dirR = 1;\r\n  end\r\n  \r\n  3'b001: begin // Atras\r\n    onL = 1; dirL = 1;\r\n    onR = 1; dirR = 0;\r\n  end\r\n  \r\n  3'b010: begin // Giro derecha\r\n    onL = 1; dirL = 0;\r\n    onR = 1; dirR = 0;\r\n  end\r\n\r\n  3'b011: begin // Giro izquierda\r\n    onL = 1; dirL = 1;\r\n    onR = 1; dirR = 1;\r\n  end\r\n\r\n  3'b100: begin // Arco derecha\r\n    onL = 0; dirL = 0;\r\n    onR = 1; dirR = 0;\r\n  end\r\n\r\n  3'b101: begin // Arco izquierda atras\r\n    onL = 1; dirL = 1;\r\n    onR = 0; dirR = 0;\r\n  end\r\n\r\n  3'b110: begin // Arco izquierda\r\n    onL = 0; dirL = 0;\r\n    onR = 1; dirR = 1;\r\n  end\r\n\r\n  3'b111: begin // Arco derecha atras\r\n    onL = 0; dirL = 0;\r\n    onR = 1; dirR = 0;\r\n  end\r\n  endcase\r\nend\r\n\r\nassign a = onL;\r\nassign b = dirL;\r\nassign c = onR;\r\nassign d = dirR;\r\n",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "e7fbd1a1-8034-4272-854e-3bf9a8eb4d8c",
          "type": "basic.info",
          "data": {
            "info": "**Rueda Izquierda**",
            "readonly": true
        ...
        {
          "id": "b79dcae6-5c33-4326-9827-39ea564a0208",
          "type": "basic.info",
          "data": {
            "info": "De cada 2 segundos reproduce uno de los diferenentes movimientos\nque puede realizar el Icebot.\n\n<b>Josep Montoliu i Sanahuja - klarojms </b>",
            "readonly": true
          },
          "position": {
            "x": 352,
      ...
      "wires": [
        {
          "source": {
            "block": "ef5c4f9f-a4ad-45fe-b63e-0b0b0d07cbb8",
            "port": "910bbdc3-5979-4834-ab08-a96083e784ce"
          },
          "target": {
            "block": "318e54b2-3d50-40e2-a615-784532451871",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "9024c69b-70a5-4b82-8c97-d10222452a4c",
            "port": "910bbdc3-5979-4834-ab08-a96083e784ce"
          },
          "target": {
            "block": "ac30d327-689d-431d-98f8-8fd0293c6d16",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "44f1d6ea-4a48-4505-b3f4-1d3adec25aa6",
            "port": "a"
          },
          "target": {
            "block": "ef5c4f9f-a4ad-45fe-b63e-0b0b0d07cbb8",
        ...
        {
          "source": {
            "block": "e06d3fc2-5778-4518-b109-110a660636bf",
        ...
        {
          "source": {
            "block": "0e664415-eefd-437d-891e-cd43e9f751e3",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "1e5f3b1d-b9e7-474a-aff2-826df1bd2d51",
