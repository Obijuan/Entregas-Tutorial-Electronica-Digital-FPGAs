{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4fa32843-8cf3-4af5-9ad9-dfdf868b15f9",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "12fe85df-0871-4e2e-9312-1e2711ba5827",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "6c65fe4d-c73b-47fb-8c12-0cb482538c3a",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "9dfdb95e-b756-4032-9c8c-d16229007bc9",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "3abf5dc3-c6cb-4daa-9d0e-df04e937cbb5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "6e9d8ba7-2264-405f-9934-7979f8f0fe3d",
        ...
        {
          "id": "bc391cf6-8f16-476c-afe7-001362b16c80",
          "type": "f97d11b78f83014e3f27ffb06850087e01ea5690",
          "position": {
            "x": 424,
            "y": -120
        ...
        {
          "id": "a2eaab09-fc3a-4a74-8ca9-136636289532",
        ...
        {
          "id": "0faf496f-7036-4d22-9e75-8d142fafc263",
        ...
        {
          "id": "b9281d2d-4858-492f-a299-fce9389968dd",
          "type": "21c67e031dcd40b36a6cf255296e79d81519f886",
          "position": {
            "x": -112,
            "y": 144
        ...
        {
          "id": "07832b20-128d-4096-bd5e-c8ed334461bd",
          "type": "21c67e031dcd40b36a6cf255296e79d81519f886",
          "position": {
            "x": 80,
            "y": -24
        ...
        {
          "id": "28a7d5f7-7e35-40a3-b918-9dc67e90e518",
        ...
        {
          "id": "d8822f32-4cab-4f6a-8a2f-fde07c969c51",
          "type": "5cc6ec961df1a19b78d61422b28169fc0f69384b",
          "position": {
            "x": 240,
            "y": -328
        ...
        {
          "id": "8b53c1a2-f26a-4476-90e0-57d04739d85e",
        ...
        {
          "id": "70a498ab-49d4-4d8f-b9a7-18f30bf89c60",
          "type": "21cfcc19a4ad14c5fb5e8cfebd018ec356fe7542",
          "position": {
            "x": -8,
            "y": -168
        ...
        {
          "id": "270ac5f7-06d2-4749-a1ed-ac05bed06750",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "79a35213-10bb-448b-b663-fab85f504187",
          "type": "basic.info",
          "data": {
            "info": "Servo Derecho",
            "readonly": true
        ...
        {
          "id": "1e8c7bd8-9603-4ac7-bf3c-63fab6022170",
          "type": "basic.info",
          "data": {
            "info": "Cada 8 segundos permuta el servo derecho \ny el izquierdo (los mux se seleccionan\na la vez, pero el servo\nderecho está encendido en 1\ny el izquierdo está\nencendido en cero)",
            "readonly": true
          },
          "position": {
            "x": 80,
        ...
        {
          "id": "73668684-e84b-43a0-a7c6-067b169c0285",
          "type": "basic.info",
          "data": {
            "info": "Cada 4 segundos permuta\nel sentido de giro\nde antihorario a horario\n(solo funcionará el\nservo con el mux en 1)",
            "readonly": true
          },
          "position": {
            "x": 480,
        ...
        {
          "id": "bdb34539-367d-415d-be6c-7e4d33e39e12",
          "type": "basic.info",
          "data": {
            "info": "Cambia cada 2 s la marcha y el paro\npor la entrara 1",
            "readonly": true
          },
          "position": {
            "x": -72,
        ...
        {
          "id": "d82be563-578a-4ebe-8ce4-073100ee239c",
          "type": "basic.info",
          "data": {
            "info": "Cambia cada 2 s la marcha y el paro por la entrada cero",
            "readonly": true
          },
          "position": {
            "x": -72,
      ...
      "wires": [
        {
          "source": {
            "block": "6e9d8ba7-2264-405f-9934-7979f8f0fe3d",
            "port": "910bbdc3-5979-4834-ab08-a96083e784ce"
          },
          "target": {
            "block": "4fa32843-8cf3-4af5-9ad9-dfdf868b15f9",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "bc391cf6-8f16-476c-afe7-001362b16c80",
            "port": "910bbdc3-5979-4834-ab08-a96083e784ce"
          },
          "target": {
            "block": "6c65fe4d-c73b-47fb-8c12-0cb482538c3a",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "a2eaab09-fc3a-4a74-8ca9-136636289532",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "0faf496f-7036-4d22-9e75-8d142fafc263",
        ...
        },
        {
          ...
          "target": {
            "block": "b9281d2d-4858-492f-a299-fce9389968dd",
            "port": "a5b29cb3-434f-401b-b737-a353389e0983"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "07832b20-128d-4096-bd5e-c8ed334461bd",
            "port": "a5b29cb3-434f-401b-b737-a353389e0983"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "28a7d5f7-7e35-40a3-b918-9dc67e90e518",
        ...
        },
        {
          ...
          "target": {
            "block": "d8822f32-4cab-4f6a-8a2f-fde07c969c51",
            "port": "1e637a79-4a6d-495c-bcac-9664bdbe4b94"
          }
        },
        {
        ...
        {
          "source": {
            "block": "8b53c1a2-f26a-4476-90e0-57d04739d85e",
        ...
        {
          "source": {
            "block": "70a498ab-49d4-4d8f-b9a7-18f30bf89c60",
            "port": "3d584b0a-29eb-47af-8c43-c0822282ef05"
          },
          "target": {
            "block": "28a7d5f7-7e35-40a3-b918-9dc67e90e518",
        ...
        },
        {
          ...
          "target": {
            "block": "9dfdb95e-b756-4032-9c8c-d16229007bc9",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "3abf5dc3-c6cb-4daa-9d0e-df04e937cbb5",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "12fe85df-0871-4e2e-9312-1e2711ba5827",
            "port": "in"
          }
        }
      ]
