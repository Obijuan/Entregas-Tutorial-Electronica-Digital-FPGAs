  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          ...
          "type": "basic.output",
          "data": {
            "name": "ServoMotorRotacionContinua",
            "pins": [
              {
                "index": "0",
                "name": "D7",
        ...
        {
          "id": "4bf7d8ba-97cc-4d0d-a826-0878bb05b321",
          "type": "basic.input",
          "data": {
            "name": "Boton",
            "pins": [
        ...
        {
          "id": "02797af1-4ecd-4205-9b97-c8cb7a040425",
          "type": "a627f5aacef2457b46054b0e895bd70d62c19a0c",
          "position": {
            "x": 336,
            "y": 224
        ...
        {
          "id": "2eef5d47-2d55-4358-9e0d-8a04f22f8195",
          "type": "basic.info",
          "data": {
            "info": "           EduBasica-IceZUM\nManejo de un servomotor de rotación continua\ncon pulsadores.\nBasado en el ejemplo 02.Motor dos pulsadores.",
            "readonly": false
          },
          "position": {
            "x": 264,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "4bf7d8ba-97cc-4d0d-a826-0878bb05b321",
            "port": "out"
          },
          "target": {
            "block": "02797af1-4ecd-4205-9b97-c8cb7a040425",
            "port": "c1e09958-aeb1-4453-af92-da0679a91f1d"
          }
        },
        {
