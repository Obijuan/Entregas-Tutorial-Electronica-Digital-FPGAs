  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "6c748388-6469-41ce-acca-3aa98de32bfe",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "9940d9ef-ec66-4939-9cff-bd0281c830f7",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "1d148b50-fbf9-429a-912f-0da207956630",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "1e82120b-8aab-4aa6-b4de-7c30d478e63d",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "1f67a883-6cda-4c06-a58a-7194619588b9",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "465eb3ed-16a4-4ad7-977f-4f12aa4fbc2f",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "5f3d02be-f41b-4887-a6ec-8ee6bffad393",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "27bdc08d-57e7-4dc4-b419-742d299f0108",
        ...
        {
          "id": "046ecdcb-5c95-424b-b370-41fe91d2e2c9",
          "type": "basic.info",
          "data": {
            "info": "<B>Ejercicio 2</B>.  Hacer un circuito digital que haga parpadear alternativamente los LEDs 3 y 4 a la velocidad de 4 veces por segundo. Los leds 0 y 1 parpadean a la vez, una vez por segundo y los leds 7 y 6 lo hacen también una vez por segundo pero alternativamente con los leds 0 y 1",
            "readonly": true
          },
          "position": {
            "x": -336,
        ...
        {
          "id": "59fd8e62-5130-40cd-b10b-185755b66222",
        ...
        {
          "id": "53a1e26a-f3b1-4dbf-9b0f-a31d07d55c28",
          "type": "7f3e9f0a05c929c3761852e259027fbe8e977795",
          "position": {
            "x": -168,
            "y": 312
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "27bdc08d-57e7-4dc4-b419-742d299f0108",
        ...
        },
        {
          ...
          "target": {
            "block": "6c748388-6469-41ce-acca-3aa98de32bfe",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "1f67a883-6cda-4c06-a58a-7194619588b9",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "5f3d02be-f41b-4887-a6ec-8ee6bffad393",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "59fd8e62-5130-40cd-b10b-185755b66222",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "1d148b50-fbf9-429a-912f-0da207956630",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "53a1e26a-f3b1-4dbf-9b0f-a31d07d55c28",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
          ...
          "target": {
            "block": "1e82120b-8aab-4aa6-b4de-7c30d478e63d",
            "port": "in"
          }
        }
      ]
