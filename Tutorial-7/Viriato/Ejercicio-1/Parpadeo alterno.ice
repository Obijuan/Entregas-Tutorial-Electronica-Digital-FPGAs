  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "a81b92a6-ee78-48b8-81ce-dc4855b0b206",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "af318924-41b5-4d40-a8f5-91ba3d7c240d",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "65f28d61-d510-41a2-a9f0-44b45d7f5f42",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "cc3723f8-2bcb-42c2-aa02-57c5fcc518d0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "0430dba7-b693-4176-a7b9-9d8fdd492f76",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "45cd2a1e-a76c-4721-a0ae-346fa8b7d1ac",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "60af771e-ca21-40e4-8b50-88aefb8d62e5",
        ...
        {
          "id": "4e7910d9-0b09-4868-a23b-76a4047b1701",
          "type": "basic.info",
          "data": {
            "info": "Hoy <b>@Wernitzer</b> me ha prestado su Icezum.",
            "readonly": true
          },
          "position": {
            "x": 184,
      ...
      "wires": [
        {
          "source": {
            "block": "60af771e-ca21-40e4-8b50-88aefb8d62e5",
        ...
        },
        {
          ...
          "target": {
            "block": "45cd2a1e-a76c-4721-a0ae-346fa8b7d1ac",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "a81b92a6-ee78-48b8-81ce-dc4855b0b206",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "af318924-41b5-4d40-a8f5-91ba3d7c240d",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "65f28d61-d510-41a2-a9f0-44b45d7f5f42",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "0430dba7-b693-4176-a7b9-9d8fdd492f76",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "cc3723f8-2bcb-42c2-aa02-57c5fcc518d0",
            "port": "in"
          }
        }
      ]
