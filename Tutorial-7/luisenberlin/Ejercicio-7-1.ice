{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "3f1e56e2-6cc3-46e8-881c-3f83ab89dd0b",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "090e3dcc-2326-439e-a357-9c63aa8b7b68",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "554003a1-9527-4d65-9512-575628a309d0",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "f56e239b-6509-4efe-b3dc-df1cc0566613",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "e18e209a-c0de-4715-8078-f2162b4b6999",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "c090864e-1352-4e0d-bf6a-ecf274683f7b",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "6bdc63dc-afe7-4f58-8d1f-42d633ffa27e",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        {
          "id": "439bd092-f7c7-4cb8-8cd5-4955e3282098",
          "type": "basic.output",
          "data": {
            "name": "led",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Tutorial 7 #FPGAwars</h1>\n<B>Ejercicio 7.1</B>: Hacer un circuito digital que haga parpadear\nalternativamente los LEDs pares y los impares a una velocidad de una vez por segundo\n\n  ",
            "readonly": true
          },
          "position": {
            "x": -32,
        ...
        {
          "id": "a6a8dbf0-f0ed-4704-8350-021689c880aa",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "2faa1b20-1125-4d47-9062-f7c3b0cab1e1",
        ...
        {
          "id": "a6e4b1bc-46c1-44a6-8d4b-3afff9ca375f",
      ...
      "wires": [
        {
          "source": {
            "block": "a6e4b1bc-46c1-44a6-8d4b-3afff9ca375f",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "554003a1-9527-4d65-9512-575628a309d0",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "e18e209a-c0de-4715-8078-f2162b4b6999",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "439bd092-f7c7-4cb8-8cd5-4955e3282098",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "2faa1b20-1125-4d47-9062-f7c3b0cab1e1",
        ...
        },
        {
          ...
          "target": {
            "block": "c090864e-1352-4e0d-bf6a-ecf274683f7b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "090e3dcc-2326-439e-a357-9c63aa8b7b68",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "3f1e56e2-6cc3-46e8-881c-3f83ab89dd0b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "6bdc63dc-afe7-4f58-8d1f-42d633ffa27e",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "f56e239b-6509-4efe-b3dc-df1cc0566613",
            "port": "in"
          }
        }
      ]
