{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "2f208774-6672-4827-8ef0-bb5e8b6f980e",
          "type": "basic.input",
          "data": {
            "name": "dir IZQ",
            "pins": [
        ...
        {
          "id": "dedabed7-bf13-4483-9cf0-437af2414644",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "8beb86df-faff-4a68-ab23-5fd9934b26ed",
          "type": "basic.input",
          "data": {
            "name": "go IZQ",
            "pins": [
        ...
        {
          "id": "e93388a1-b5f1-4e84-8d4b-2ac72880e031",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "13255181-bac2-461f-9470-768fd6c90de1",
          "type": "basic.input",
          "data": {
            "name": "dir DCH",
            "pins": [
        ...
        {
          "id": "b5178826-e442-4c6e-b8e0-d51c929bcd8f",
          "type": "basic.output",
          "data": {
            "name": "leds ",
            "range": "[3:0]",
        ...
        {
          "id": "7929fac5-01ac-41fb-a313-c9b5b179f580",
          "type": "basic.input",
          "data": {
            "name": "go DCH",
            "pins": [
        ...
        {
          "id": "b6fa3066-f38a-48f2-bfaa-0311c85f7fa5",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "00000000\n00000000\n00001000\n00001010\n00000101\n00000101\n00001101\n00001111\n00000000\n00000000\n00001000\n00001010\n00000100\n00000100\n00001100\n00001110",
        ...
        {
          "id": "0867da66-8349-41bd-a6b4-dcf1473be6c6",
        ...
        {
          "id": "90f80a65-fec7-41df-bdbb-cabd6880ad18",
        ...
        {
          "id": "691079a5-18cd-43b6-9eef-0cb0905a9982",
        ...
        {
          "id": "76472ca8-6246-43a8-8400-d8297f37794d",
        ...
        {
          "id": "20462c58-9e62-4013-8ef9-24fc78ef4bf1",
          "type": "d4bd0427fb21ebb734fc9a18df1fcc2006219425",
          "position": {
            "x": 72,
            "y": 504
        ...
        {
          "id": "7eaa9e5e-2798-4715-83d0-5764373d5cf0",
          "type": "basic.info",
          "data": {
            "info": "IZQ DCH\nd g g d (dir go)\n0 0 0 0 // 0  Stop\n0 0 0 1 // 0  Stop\n0 0 1 0 // 8  \n0 0 1 1 // 10  \n0 1 0 0 // 5\n0 1 0 1 // 5\n0 1 1 0 // 13\n0 1 1 1 // 15\n1 0 0 0 // 0  Stop\n1 0 0 1 // 0  Stop\n1 0 1 0 // 8\n1 0 1 1 // 10\n1 1 0 0 // 4\n1 1 0 1 // 4\n1 1 1 0 // 12\n1 1 1 1 // 14\n",
            "readonly": false
        ...
        {
          "id": "ba73aec5-5b53-4c6e-b52b-6df4586af002",
          "type": "basic.info",
          "data": {
            "info": "## 22.4",
            "readonly": true
      ...
      "wires": [
        {
          "source": {
            "block": "0867da66-8349-41bd-a6b4-dcf1473be6c6",
            "port": "fcbbbbd8-842e-4302-88fd-00187a8e974d"
          },
          "target": {
            "block": "dedabed7-bf13-4483-9cf0-437af2414644",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "e93388a1-b5f1-4e84-8d4b-2ac72880e031",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "90f80a65-fec7-41df-bdbb-cabd6880ad18",
        ...
        {
          "source": {
            "block": "b6fa3066-f38a-48f2-bfaa-0311c85f7fa5",
            "port": "memory-out"
          },
          "target": {
            "block": "90f80a65-fec7-41df-bdbb-cabd6880ad18",
        ...
        {
          "source": {
            "block": "691079a5-18cd-43b6-9eef-0cb0905a9982",
        ...
        {
          "source": {
            "block": "76472ca8-6246-43a8-8400-d8297f37794d",
        ...
        {
          "source": {
            "block": "20462c58-9e62-4013-8ef9-24fc78ef4bf1",
            "port": "99661aef-c9bf-473e-93c4-8f5edf511d36"
          },
          "target": {
            "block": "691079a5-18cd-43b6-9eef-0cb0905a9982",
        ...
        {
          "source": {
            "block": "2f208774-6672-4827-8ef0-bb5e8b6f980e",
            "port": "out"
          },
          "target": {
            "block": "76472ca8-6246-43a8-8400-d8297f37794d",
        ...
        {
          "source": {
            "block": "8beb86df-faff-4a68-ab23-5fd9934b26ed",
            "port": "out"
          },
          "target": {
            "block": "76472ca8-6246-43a8-8400-d8297f37794d",
        ...
        {
          "source": {
            "block": "13255181-bac2-461f-9470-768fd6c90de1",
            "port": "out"
          },
          "target": {
            "block": "20462c58-9e62-4013-8ef9-24fc78ef4bf1",
        ...
        {
          "source": {
            "block": "7929fac5-01ac-41fb-a313-c9b5b179f580",
            "port": "out"
          },
          "target": {
            "block": "20462c58-9e62-4013-8ef9-24fc78ef4bf1",
        ...
        },
        {
          ...
          "target": {
            "block": "b5178826-e442-4c6e-b8e0-d51c929bcd8f",
            "port": "in"
          },
          "size": 4
        }
