{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7f612911-c909-460c-8d1e-ed9fbca75a77",
          "type": "basic.input",
          "data": {
            "name": "IR_1",
            "pins": [
        ...
        {
          "id": "71786e46-0101-401d-b4bf-2e3a5deb8bbd",
          "type": "basic.output",
          "data": {
            "name": "SERVO",
            "pins": [
        ...
        {
          "id": "f5c4fef0-6cef-4ed8-b243-b5755201a246",
          "type": "basic.input",
          "data": {
            "name": "IR_0",
            "pins": [
        ...
        {
          "id": "7384b24f-ffb7-4743-88ba-a3097ce202c0",
          "type": "basic.memory",
          "data": {
            "name": "TABLA",
            "list": "1\n0\n1\n0",
        ...
        {
          "id": "b457b8ab-99ac-4400-a12c-4f121a1f5c24",
          "type": "basic.info",
          "data": {
            "info": "**Ejercicio 19.1:** (5 Bitpoints) Fraky en modo defensivo\n\nDiseñar un **circuito combinacional**, mediante su **tabla de verdad**, para controlar la posición del cuello de Franky mediante dos **sensores de infrarrojos**: izquierdo y derecho. \nCuando ningún sensor esté activado, o sólo lo esté izquierdo, Franky mirará hacia la izquierda. \nCuando el sensor derecho está activado, o ambos (izquierdo y derecho), Franky mirará hacia la derecha.",
            "readonly": true
          },
          "position": {
            "x": -88,
        ...
        {
          "id": "1f3d36c8-7ae6-4fd9-af32-351b246a0916",
        ...
        {
          "id": "e51a38d7-c192-4842-aa82-135c2697b25e",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "cd6685ad-b780-484f-91b0-ef1c8a523237",
          "type": "basic.info",
          "data": {
            "info": "|   IR    | Posición   | Tabla |\n|---------|------------|-------|\n| **IR_1**| Izquierdo  |   i1  |\n| **IR_0**|  Derecho   |   i0  |",
            "readonly": true
          },
          "position": {
            "x": -8,
        ...
        {
          "id": "22b4aa99-2dfb-4744-91a3-5d0183f82279",
          "type": "basic.info",
          "data": {
            "info": "| SERVO | Posición   |\n|-------|------------|\n|   0   |  Derecha   |\n|   1   | Izquierda  |",
            "readonly": true
        ...
        {
          "id": "03cee07b-eef4-4322-bdce-09bbd57dc04b",
      ...
      "wires": [
        {
          "source": {
            "block": "7f612911-c909-460c-8d1e-ed9fbca75a77",
            "port": "out"
          },
          "target": {
            "block": "1f3d36c8-7ae6-4fd9-af32-351b246a0916",
            "port": "ace53645-b2e3-46be-beae-4ada8d69586e"
          }
        },
        {
          "source": {
            "block": "7384b24f-ffb7-4743-88ba-a3097ce202c0",
            "port": "memory-out"
          },
          "target": {
            "block": "1f3d36c8-7ae6-4fd9-af32-351b246a0916",
        ...
        {
          "source": {
            "block": "03cee07b-eef4-4322-bdce-09bbd57dc04b",
            "port": "52f2f09c-75c4-49b9-bb9c-20000df9e5cc"
          },
          "target": {
            "block": "71786e46-0101-401d-b4bf-2e3a5deb8bbd",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "f5c4fef0-6cef-4ed8-b243-b5755201a246",
            "port": "out"
          },
          "target": {
            "block": "1f3d36c8-7ae6-4fd9-af32-351b246a0916",
