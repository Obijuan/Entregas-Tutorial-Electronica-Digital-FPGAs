{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "fcb7055f-d5cc-4e5c-85b8-61b96a19346b",
          "type": "basic.output",
          "data": {
            "name": "Led",
            "pins": [
        ...
        {
          "id": "8c5a28ec-91ce-447b-896f-f5de3164d683",
        ...
        {
          "id": "552176e6-7f29-4942-92cf-dac76bd70370",
          "type": "basic.info",
          "data": {
            "info": "El ejercicio libre es un metronomo con cuatro posciones y marcando el prime tiempo como fuerte\ny los otros 3 debiles:\n \n 1.- 2 segundos por tiempo\n 2.- 1 segundo por tienpo\n 3.- 1/2 segundo por tiempo\n 4.- 1/3 segundo por tiempo\n \n <b>Josep Montoliu i Sanahuka (klarojms)</b>\n ",
            "readonly": true
          },
          "position": {
            "x": -1584,
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "//parameter HZ=1;\r\n\r\n//-- Constante para dividir y obtener una frecuencia de 1Hz\r\nlocalparam M1 = 12000000*2;\r\n\r\nlocalparam M2 = 12000000;\r\n\r\nlocalparam M3 = 12000000/2;\r\n\r\nlocalparam M4 = 12000000/3;\r\n\r\nlocalparam Status = 0;\r\n\r\n//-- Calcular el numero de bits para almacenar M1\r\n//-- Calcular el numero de bits para almacenar M1\r\nlocalparam N = $clog2(M1);\r\n\r\n//-- Registro del divisor\r\nreg [N-1:0] divcounter;\r\n\r\n//-- Temporal clock\r\nreg clk_t = 0;\r\n\r\nreg [1:0] tempo = 0;\r\n\r\nalways @(posedge clk) begin\r\n  case (state)\r\n  2'b00: begin //DO4 / MI4\r\n    if (divcounter > M1/2) begin\r\n      clk_t <= 1;\r\n      divcounter = 0;\r\n    end else begin\r\n      divcounter <=  divcounter + 1;\r\n      clk_t = 0;\r\n    end\r\n  end\r\n  \r\n  2'b01: begin //RE4 / FAS4\r\n    if (divcounter > M2/2) begin\r\n      clk_t <= 1;\r\n      divcounter = 0;\r\n    end else begin\r\n      divcounter <=  divcounter + 1;\r\n      clk_t = 0;\r\n    end \r\n  end\r\n  \r\n  2'b10: begin //MI4 / SOL4\r\n    if (divcounter > M3/2) begin\r\n      clk_t <= 1;\r\n      divcounter = 0;\r\n    end else begin\r\n      divcounter <=  divcounter + 1;\r\n      clk_t = 0;\r\n    end \r\n  end\r\n\r\n  2'b11: begin //FAS4 / LA4\r\n    if (divcounter > M4/2) begin\r\n      clk_t <= 1;\r\n      divcounter = 0;\r\n    end else begin\r\n      divcounter <=  divcounter + 1;\r\n      clk_t = 0;\r\n    end \r\n  end\r\n  endcase\r\nend\r\n\r\nreg out = 0;  \r\nreg fuerte = 0;   \r\n\r\n//-- Biestable T para obtener ciclo de trabajo del 50%\r\nalways @(posedge clk)\r\n  if (clk_t) begin \r\n    out <= ~out;\r\n    if (out) begin\r\n      if (tempo==0)\r\n        fuerte <= 0;\r\n      else\r\n        fuerte <= 1;\r\n      tempo <= tempo+1;\r\n    end\r\n  end\r\n\r\n",
            "params": [],
            "ports": {
              "in": [
                {
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "fcb7055f-d5cc-4e5c-85b8-61b96a19346b",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "8c5a28ec-91ce-447b-896f-f5de3164d683",
