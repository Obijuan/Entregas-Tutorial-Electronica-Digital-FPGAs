{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "93dfac55-384d-4c51-9f17-1a3744d54a3f",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "df9c4da1-8423-490e-b50a-97008018f353",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "34544e11-eae8-4883-b343-eacb9effcbbb",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "50b85a48-972c-4f5c-bc61-576d70d10480",
          "type": "basic.input",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "d4824060-86a7-4a5a-b9d9-0cd8c5d084f7",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "0\n0\n0\n1\n0\n1\n0\n0",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1 align=\"center\">TUTORIAL 19</h1>\n<h2 align=\"center\">EJERCICIO 2</h2>\n\n<h3 align=\"center\">APERTURA DE CAJA FUERTE </p>\nDiseñar un circuito combinacional, mediante su tabla de verdad, para abrir la puerta de una caja fuerte cuando se introducen los códigos correctos. </p>\nSe usarán __tres interruptores externos para introducir la clave__.</p>\nCuando esta clave sea 101 ó 011 se moverá un servo a la otra posición, simulando la apertura de la caja</h3>",
            "readonly": true
          },
          "position": {
            "x": -3336,
        ...
        {
          "id": "a7cd4df1-5e32-4f85-bae7-9b9052ef601d",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "6f1df210-cad5-4c18-8c6d-803f6c1d17ca",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "c58989f9-1f1f-4ce1-8246-54640e4cb59b",
          "type": "basic.info",
          "data": {
            "info": "0: Cerrada  \n1: Abierta  ",
            "readonly": true
        ...
        {
          "id": "3d658530-357d-413a-b6bc-7cc8f768a520",
        ...
        {
          "id": "09d17490-c035-4b76-b33c-363b8e82c71a",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "644b2f12-dca1-4baa-bbd5-b4d670036614",
      ...
      "wires": [
        {
          "source": {
            "block": "50b85a48-972c-4f5c-bc61-576d70d10480",
            "port": "out"
          },
          "target": {
            "block": "3d658530-357d-413a-b6bc-7cc8f768a520",
        ...
        {
          "source": {
            "block": "d4824060-86a7-4a5a-b9d9-0cd8c5d084f7",
            "port": "memory-out"
          },
          "target": {
            "block": "3d658530-357d-413a-b6bc-7cc8f768a520",
        ...
        {
          "source": {
            "block": "34544e11-eae8-4883-b343-eacb9effcbbb",
            "port": "out"
          },
          "target": {
            "block": "3d658530-357d-413a-b6bc-7cc8f768a520",
        ...
        {
          "source": {
            "block": "93dfac55-384d-4c51-9f17-1a3744d54a3f",
            "port": "out"
          },
          "target": {
            "block": "3d658530-357d-413a-b6bc-7cc8f768a520",
        ...
        {
          "source": {
            "block": "644b2f12-dca1-4baa-bbd5-b4d670036614",
            "port": "dd28d456-e7a5-40ee-be2f-be3b0c65def9"
          },
          "target": {
            "block": "df9c4da1-8423-490e-b50a-97008018f353",
            "port": "in"
          },
          "vertices": []
        },
