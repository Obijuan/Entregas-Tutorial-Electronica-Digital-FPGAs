{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "dc52f7b6-e3ef-408a-938e-16964b22156e",
          "type": "basic.output",
          "data": {
            "name": "ojos",
            "range": "[1:0]",
        ...
        {
          "id": "4c1e33bc-bac7-40a4-83a3-2c9af8232113",
          "type": "basic.input",
          "data": {
            "name": "disparar",
            "pins": [
        ...
        {
          "id": "2d23ee74-bbdc-4790-bdc5-a5cd0b59f1e0",
          "type": "basic.input",
          "data": {
            "name": "cuello",
            "pins": [
        ...
        {
          "id": "a313075f-4026-49ba-bb27-a182ceaf4784",
          "type": "basic.output",
          "data": {
            "name": "servo",
            "pins": [
        ...
        {
          "id": "3499dc19-bc6e-48de-ab6d-97d070fd7bb6",
          "type": "basic.constant",
          "data": {
            "name": "Hz",
            "value": "10",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1 align=\"center\">TUTORIAL 21</h1>\n<h2 align=\"center\">EJERCICIO 3</h2>\n\n<h3 align=\"center\">BLOQUE FRANKY</p>\nDiseñar un bloque para controlar a Franky. Tendrá 2 puertos de entrada de un bit (además del de reloj).</p>\nUno hará que Franky dispare por sus ojos, cuando se ponga a 1, y no dispare mientras esté a 0. El disparo es un parpadeo de los ojos a una frecuencia definida por el usuario mediante un parámetro. Por** defecto** será de 10Hz. La otra entrada hará que Franky mire hacia un lado (1) o hacia el otro (0). Tendrá como salidas un puerto de 2 bits para los LEDs de los ojos, y uno de un bit para el control del servo del cuello.</p>\nTendrá un parámetro para especificar la frecuencia del parpadeo de los ojos en el disparo.</p>\n\nHacer un circuito de prueba del bloque, conectando la entrada de disparo a un pulsador y la del cuello a un interruptor</h3>",
            "readonly": true
          },
          "position": {
            "x": -2976,
        ...
        {
          "id": "9cfc3628-c2c1-4e80-9a45-dbecf6f4f5b1",
          "type": "a8262a448793f0abdfd2feb70f4ab4ac18d1de95",
          "position": {
            "x": -2480,
            "y": -1600
          },
      ...
      "wires": [
        {
          "source": {
            "block": "9cfc3628-c2c1-4e80-9a45-dbecf6f4f5b1",
            "port": "253879a0-74e7-4b8b-8c92-2e642adc4881"
          },
          "target": {
            "block": "a313075f-4026-49ba-bb27-a182ceaf4784",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "3499dc19-bc6e-48de-ab6d-97d070fd7bb6",
            "port": "constant-out"
          },
          "target": {
            "block": "9cfc3628-c2c1-4e80-9a45-dbecf6f4f5b1",
            "port": "37982960-d0b4-48de-a983-bd5990eba0b6"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "4c1e33bc-bac7-40a4-83a3-2c9af8232113",
            "port": "out"
          },
          "target": {
            "block": "9cfc3628-c2c1-4e80-9a45-dbecf6f4f5b1",
            "port": "15879047-5e8f-43eb-8aaf-0575d3aaa91a"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "2d23ee74-bbdc-4790-bdc5-a5cd0b59f1e0",
            "port": "out"
          },
          "target": {
            "block": "9cfc3628-c2c1-4e80-9a45-dbecf6f4f5b1",
            "port": "35a8dcea-2477-4b4b-8fbb-3b45a3846044"
          },
          "vertices": [
            {
              "x": -2544,
        ...
        },
        {
          "source": {
            "block": "9cfc3628-c2c1-4e80-9a45-dbecf6f4f5b1",
            "port": "92fd620e-9252-4568-921d-03dbbca15708"
          },
          "target": {
            "block": "dc52f7b6-e3ef-408a-938e-16964b22156e",
            "port": "in"
          },
          "size": 2
        }
  ...
  "dependencies": {
    "a8262a448793f0abdfd2feb70f4ab4ac18d1de95": {
      "package": {
        "name": "Franky",
        "version": "1.0",
        "description": "Franky sorprendido",
        "author": "Ángel Millán León",
        "image": "%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20height=%22197.291%22%20width=%22172.953%22%20viewBox=%220%200%2072.063923%2082.204374%22%3E%3Cpath%20fill=%22#aab%22%20stroke=%22#111%22%20stroke-width=%223.003%22%20stroke-linejoin=%22round%22%20d=%22M66.125%204.293l-5.806-2.774-7.027%2014.708L59.098%2019zM4.761%204.275l5.806-2.774%207.027%2014.708-5.806%202.774z%22/%3E%3Crect%20x=%222.145%22%20y=%2211.427%22%20width=%2267.774%22%20height=%2268.632%22%20ry=%229.317%22%20fill=%22#aab%22%20stroke=%22#111%22%20stroke-width=%224.29%22%20stroke-linejoin=%22round%22/%3E%3Cg%20transform=%22matrix(.9232%200%200%20.8011%202.244%2014.245)%22%20stroke=%22#111%22%20stroke-width=%222.481%22%20stroke-linejoin=%22round%22%3E%3Crect%20x=%2214.957%22%20y=%2256.41%22%20width=%2243.007%22%20height=%2214.317%22%20ry=%227.158%22%20rx=%2212.676%22%20fill=%22#eee%22/%3E%3Cpath%20d=%22M22.891%2056.144v14.183m25.491-14.183v14.183M31.228%2056.144v14.183m8.59-14.183v14.183m-24.79-7.391h42.405%22%20fill=%22none%22/%3E%3C/g%3E%3Cg%20transform=%22matrix(.8107%200%200%20.82837%203.727%208.475)%22%20fill=%22#f87%22%20stroke=%22#111%22%20stroke-width=%222.484%22%20stroke-linejoin=%22round%22%3E%3Cellipse%20cx=%2224.304%22%20cy=%2229.906%22%20ry=%228.872%22%20rx=%229.582%22/%3E%3Ccircle%20cx=%2224.659%22%20cy=%2229.196%22%20r=%221.774%22/%3E%3C/g%3E%3Cpath%20d=%22M25.622%2016.687L7.772%2026.993%22%20fill=%22#aab%22%20stroke=%22#000%22%20stroke-width=%223.75%22/%3E%3Cg%3E%3Cg%20transform=%22matrix(-.8107%200%200%20.82837%2068.081%208.475)%22%20fill=%22#f87%22%20stroke=%22#111%22%20stroke-width=%222.484%22%20stroke-linejoin=%22round%22%3E%3Cellipse%20cx=%2224.304%22%20cy=%2229.906%22%20ry=%228.872%22%20rx=%229.582%22/%3E%3Ccircle%20cx=%2224.659%22%20cy=%2229.196%22%20r=%221.774%22/%3E%3C/g%3E%3Cpath%20d=%22M46.187%2016.687l17.85%2010.306%22%20fill=%22#aab%22%20stroke=%22#000%22%20stroke-width=%223.75%22/%3E%3C/g%3E%3Cg%20fill=%22none%22%20stroke=%22#000%22%20stroke-width=%223.75%22%3E%3Cpath%20d=%22M35.904%2040.965v10.918M41.364%2052.943H30.445%22/%3E%3C/g%3E%3C/svg%3E"
      },
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "a2ae93c7-047e-4f46-999d-3063d0cd6533",
              "type": "basic.input",
              "data": {
                "name": "",
                "clock": true
            ...
            {
              "id": "92fd620e-9252-4568-921d-03dbbca15708",
              "type": "basic.output",
              "data": {
                "name": "ojos ",
                "range": "[1:0]",
            ...
            {
              "id": "15879047-5e8f-43eb-8aaf-0575d3aaa91a",
              "type": "basic.input",
              "data": {
                "name": "disparar",
                "clock": false
            ...
            {
              "id": "253879a0-74e7-4b8b-8c92-2e642adc4881",
              "type": "basic.output",
              "data": {
                "name": "servo"
              },
            ...
            {
              "id": "35a8dcea-2477-4b4b-8fbb-3b45a3846044",
              "type": "basic.input",
              "data": {
                "name": "cuello",
                "clock": false
            ...
            {
              "id": "37982960-d0b4-48de-a983-bd5990eba0b6",
              "type": "basic.constant",
              "data": {
                "name": "Hz",
                "value": "",
            ...
            {
              "id": "e07a8395-7052-4452-8607-eed857b924ba",
            ...
            {
              "id": "282ec3d3-8542-4f5c-bc8b-97671b7009e3",
            ...
            {
              "id": "c36e2e74-f5d4-48fc-a860-8809ef97d72f",
            ...
            {
              "id": "1b347031-c07a-4a79-b502-dc2accf3be6e",
          ...
          "wires": [
            {
              "source": {
                "block": "c36e2e74-f5d4-48fc-a860-8809ef97d72f",
                "port": "664caf9e-5f40-4df4-800a-b626af702e62"
              },
              "target": {
                "block": "282ec3d3-8542-4f5c-bc8b-97671b7009e3",
            ...
            {
              "source": {
                "block": "e07a8395-7052-4452-8607-eed857b924ba",
            ...
            },
            {
              ...
              "target": {
                "block": "92fd620e-9252-4568-921d-03dbbca15708",
                "port": "in"
              },
              "size": 2
            },
            {
              "source": {
                "block": "15879047-5e8f-43eb-8aaf-0575d3aaa91a",
                "port": "out"
              },
              "target": {
                "block": "c36e2e74-f5d4-48fc-a860-8809ef97d72f",
            ...
            {
              "source": {
                "block": "35a8dcea-2477-4b4b-8fbb-3b45a3846044",
                "port": "out"
              },
              "target": {
                "block": "1b347031-c07a-4a79-b502-dc2accf3be6e",
                "port": "8c270da8-143a-4c1d-ba63-a206b366a99a"
              }
            },
            {
              "source": {
                "block": "a2ae93c7-047e-4f46-999d-3063d0cd6533",
                "port": "out"
              },
              "target": {
                "block": "e07a8395-7052-4452-8607-eed857b924ba",
            ...
            },
            {
              ...
              "target": {
                "block": "253879a0-74e7-4b8b-8c92-2e642adc4881",
                "port": "in"
              }
            },
            {
              "source": {
                "block": "37982960-d0b4-48de-a983-bd5990eba0b6",
                "port": "constant-out"
              },
              "target": {
                "block": "e07a8395-7052-4452-8607-eed857b924ba",
