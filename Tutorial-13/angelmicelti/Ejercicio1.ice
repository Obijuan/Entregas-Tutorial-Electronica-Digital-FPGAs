{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "8ad1e8c2-19fd-410e-ba13-d0d42078ab1d",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "8309cad2-8db4-4903-9271-e137ade8c717",
          "type": "basic.input",
          "data": {
            "name": "Interruptor",
            "pins": [
        ...
        {
          "id": "dc1d5459-3621-46a2-a4f2-bf7dabb83201",
          "type": "basic.output",
          "data": {
            "name": "Zumbador",
            "pins": [
        ...
        {
          "id": "8d912f1e-51ec-4ffa-bc4b-61f822ba08eb",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "9f365cde-e12f-498e-a8da-e2619b3b0896",
          "type": "basic.input",
          "data": {
            "name": "Pulsador",
            "pins": [
        ...
        {
          "id": "7492655e-f88d-447a-9aba-1b6c22c2dcd2",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1 align=\"center\">TUTORIAL 13 </h1>\n<h2 align=\"center\">EJERCICIO 1</h2>\n\n<h3 align=\"center\"> Utilizar un interruptor externo para mover el cuello de Franky de un lado a otro. Al apretar un pulsador externo sus ojos parpadearán a 10 Hz. Cada vez que los ojos estén encendidos se emitirá un tono de 1Khz (como los ojos se encienden y a 10Hz, también lo hará el tono de 1Khz)</h3>",
            "readonly": true
          },
          "position": {
            "x": -2928,
        ...
        {
          "id": "4771150e-9d7d-47a3-8a06-d2e94f722d2d",
        ...
        {
          "id": "f6280d09-9687-48b8-8411-5ebd20d005f0",
        ...
        {
          "id": "c8b58a04-575c-447b-8806-2c8864c1819a",
        ...
        {
          "id": "06e58eb1-9d94-4fed-bd67-8ccc3986d49a",
        ...
        {
          "id": "317d5899-eeaa-43d1-a190-88db32ed396b",
          "type": "b2090f68ef94fd3c5c0eaea93eb6ba7e80aff0b6",
          "position": {
            "x": -2704,
            "y": -1280
        ...
        {
          "id": "c77783bf-7080-4def-bdfc-15a7219405e6",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "dc18842e-9fb8-4cf3-b811-c6ea295d0d60",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "a8711fc7-02e6-46e3-8319-1f452f8ab484",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "ebd22d4f-f8ea-4ac3-b2b8-0b93f2fb3885",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        {
          "source": {
            "block": "4771150e-9d7d-47a3-8a06-d2e94f722d2d",
            "port": "52f2f09c-75c4-49b9-bb9c-20000df9e5cc"
          },
          "target": {
            "block": "8ad1e8c2-19fd-410e-ba13-d0d42078ab1d",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "8309cad2-8db4-4903-9271-e137ade8c717",
            "port": "out"
          },
          "target": {
            "block": "4771150e-9d7d-47a3-8a06-d2e94f722d2d",
        ...
        {
          "source": {
            "block": "c8b58a04-575c-447b-8806-2c8864c1819a",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "8d912f1e-51ec-4ffa-bc4b-61f822ba08eb",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "7492655e-f88d-447a-9aba-1b6c22c2dcd2",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "f6280d09-9687-48b8-8411-5ebd20d005f0",
        ...
        {
          "source": {
            "block": "9f365cde-e12f-498e-a8da-e2619b3b0896",
            "port": "out"
          },
          "target": {
            "block": "c8b58a04-575c-447b-8806-2c8864c1819a",
        ...
        {
          "source": {
            "block": "317d5899-eeaa-43d1-a190-88db32ed396b",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "dc1d5459-3621-46a2-a4f2-bf7dabb83201",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "06e58eb1-9d94-4fed-bd67-8ccc3986d49a",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "317d5899-eeaa-43d1-a190-88db32ed396b",
