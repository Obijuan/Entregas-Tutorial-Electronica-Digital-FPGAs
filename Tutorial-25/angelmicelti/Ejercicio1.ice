{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a1108314-3721-443e-b6ec-2b6cbf4878ba",
          "type": "basic.output",
          "data": {
            "name": "SERVO",
            "pins": [
        ...
        {
          "id": "8f5a80ed-8a5e-42f6-9296-5e7d35ed123a",
          "type": "basic.input",
          "data": {
            "name": "IR",
            "pins": [
        ...
        {
          "id": "1034bef9-3cc3-4076-9832-3347a6a67e2b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "8a187b85-a8af-4a0e-b69c-4648e58df49c",
          "type": "basic.input",
          "data": {
            "name": "IR",
            "pins": [
        ...
        {
          "id": "bd2ec53a-56fd-4fd7-80da-2487eaabfc67",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1 align=\"center\">TUTORIAL 25</h1>\n<h2 align=\"center\">EJERCICIO 1</h2>\n\n<h3 align=\"center\">Captando la atención de Franky   \n\n\nColocar dos sensores de infrarrojos. Franky se quedará mirando siempre al último que se haya activado.   \nSi se detecta algo por la derecha, girará su cuello hacia la derecha y permanecerá en esa posición.    \nSi detecta algo por la izquierda, girará el cuello a la izquierda y permancerá en esa posición.    \nColocar también dos LEDs, uno a la derecha y otro a la izquierda.    \nSegún en la posición en la que esté mirando Franky, se iluminará uno u otro.\n</h3>",
            "readonly": true
          },
          "position": {
            "x": -3144,
        ...
        {
          "id": "5e6c71b7-737f-4b5a-96ff-5af658a9cf4e",
        ...
        {
          "id": "fd82b601-1b03-44ff-8905-1b2a5d089864",
        ...
        {
          "id": "426b4cdc-8294-4dd8-b52e-a87ceff6661e",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "99ebc85d-7ab6-4387-906e-3e2faf9218fe",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "57427086-8cac-4c55-884e-fed57fb22876",
          "type": "basic.info",
          "data": {
            "info": "Coloco las puertas NOT porque la salida del TCRT5000 está invertida",
            "readonly": true
          },
          "position": {
            "x": -2912,
        ...
        {
          "id": "284e4a6a-4d49-49fe-b44d-b9cfb389f429",
          "type": "basic.info",
          "data": {
            "info": "**Posición de Franky**",
            "readonly": true
          },
          "position": {
            "x": -2712,
        ...
        {
          "id": "700f998c-c58e-43c7-9401-f6f73699dda7",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "7d8bb212-b2a3-461d-ab27-2209dce02d06",
        ...
        {
          "id": "ad9326f9-2ba9-4d58-85dc-1c4c8e8f4876",
          "type": "basic.info",
          "data": {
            "info": "**LED derecho**",
            "readonly": true
        ...
        {
          "id": "ae1aedb5-3777-4130-bccb-89b6b746ceee",
          "type": "basic.info",
          "data": {
            "info": "**LED izquierdo**",
            "readonly": true
        ...
        {
          "id": "9270017c-3234-4551-933c-05c219946f25",
          "type": "35f267d0df6ffcb7fc33753bc9df9cf083642cca",
          "position": {
            "x": -2896,
            "y": -1760
        ...
        {
          "id": "098e41ef-31e7-4e4b-acd5-843505b1190c",
          "type": "35f267d0df6ffcb7fc33753bc9df9cf083642cca",
          "position": {
            "x": -2896,
            "y": -1552
      ...
      "wires": [
        {
          "source": {
            "block": "5e6c71b7-737f-4b5a-96ff-5af658a9cf4e",
            "port": "8cd7e68d-a379-4703-b473-df733e6bfc68"
          },
          "target": {
            "block": "a1108314-3721-443e-b6ec-2b6cbf4878ba",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "fd82b601-1b03-44ff-8905-1b2a5d089864",
        ...
        },
        {
          ...
          "target": {
            "block": "1034bef9-3cc3-4076-9832-3347a6a67e2b",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "7d8bb212-b2a3-461d-ab27-2209dce02d06",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "bd2ec53a-56fd-4fd7-80da-2487eaabfc67",
            "port": "in"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "8f5a80ed-8a5e-42f6-9296-5e7d35ed123a",
            "port": "out"
          },
          "target": {
            "block": "9270017c-3234-4551-933c-05c219946f25",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
        ...
        {
          "source": {
            "block": "8a187b85-a8af-4a0e-b69c-4648e58df49c",
            "port": "out"
          },
          "target": {
            "block": "098e41ef-31e7-4e4b-acd5-843505b1190c",
            "port": "18c2ebc7-5152-439c-9b3f-851c59bac834"
          }
        },
        {
