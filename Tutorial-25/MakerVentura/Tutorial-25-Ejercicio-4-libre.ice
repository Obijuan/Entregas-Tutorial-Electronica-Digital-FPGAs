{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "e437bc3e-9d3e-442d-89fa-85d9ee2fcc42",
          "type": "basic.input",
          "data": {
            "name": "IR-1",
            "pins": [
        ...
        {
          "id": "cf85efb3-08a4-4eba-9a6a-9276261c84c3",
          "type": "basic.output",
          "data": {
            "name": "Motor",
            "pins": [
        ...
        {
          "id": "eed2fa7f-13ab-4e78-8f37-f7a49727f0e2",
          "type": "basic.input",
          "data": {
            "name": "IR-2",
            "pins": [
        ...
        {
          "id": "c3b8ed1f-6214-4323-ac2e-188faad92ab7",
          "type": "basic.input",
          "data": {
            "name": "Activacion",
            "pins": [
        ...
        {
          "id": "85d2d262-ffe9-4fd3-8b52-6a2d31d341f5",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "1 // No importa el sentido inicial de giro cuando ningún IR recibe señal\n1\n0\n0 // Este resultado tampoco importa , dado que el motor se apaga con los dos biestables armados",
            "local": false,
            "format": 10
          },
          "position": {
        ...
        {
          "id": "72b9e91b-e177-4e8a-8ce0-6537fd8b64ad",
        ...
        {
          "id": "ed304a68-122e-4cf2-94e7-519965b9692e",
        ...
        {
          "id": "780beb07-4953-4178-b1ab-f0740d6e29fe",
          "type": "e361954a218b18648c32794fb1b31e05eeaa43b3",
          "position": {
            "x": 488,
            "y": 440
        ...
        {
          "id": "29e34ec0-a264-498f-bc20-861d1f3bbf6d",
        ...
        {
          "id": "7a68a6dc-34ba-419d-baf3-54fc54eb8542",
        ...
        {
          "id": "cc5e77d6-62ec-4a75-a8a9-f6a86b714759",
          "type": "e361954a218b18648c32794fb1b31e05eeaa43b3",
          "position": {
            "x": 1040,
            "y": 480
        ...
        {
          "id": "8c87fb3a-0dee-4340-b8a4-6d069f428799",
        ...
        {
          "id": "31a73bf0-745f-488d-a4a0-2d08b97e9ea9",
          "type": "basic.info",
          "data": {
            "info": "Por las entradas D13 y D12 llega la señal de los los detectores de Infrarrojos que nos sirven para detectar los dos topes entre los que se mueve nuestra máquina . Este ejemplo se puede realizar tmbién cambiando los dos detectores de infrarrojos por dos finales de carrera que detecten la cercanía de las paredes o muros",
            "readonly": true
          },
          "position": {
            "x": -56,
        ...
        {
          "id": "651dc37e-6347-429a-9348-b7d74ea550ef",
          "type": "basic.info",
          "data": {
            "info": "**MakerVentura :**\n\n**Tutorial 25 :**\n\n**Ejercicio 25-4 Libre :** ( Movimiento alternativo de un motor rotativo con dos biestables )\n\n\nImaginemos como ejemplo de aplicación práctica de este circuito , el cabezal de una impresora deslizando en el eje X , por un tornillo sinfin o movido por correas entre dos posiciones extremas Xmin y Xmax marcadas por los detectores de infrarrojos o los finales de carrera.\n\nEl hecho de que la máquina se pare en caso de recibir señal somultanea de los dos IR o dos FC es una medida de seguridad .\n\nEl sistema solamente se rearma si volvemos a pulsar el botón de Activación",
            "readonly": true
          },
          "position": {
            "x": -240,
        ...
        {
          "id": "6c5256cb-21ff-4136-b907-a5ca18048763",
          "type": "basic.info",
          "data": {
            "info": "Si uno de los dos biestables se encuentra armado resetea la acción del contrario",
            "readonly": true
          },
          "position": {
            "x": 464,
        ...
        {
          "id": "e324ff0b-a8b7-4694-8159-3af204de9c49",
          "type": "basic.info",
          "data": {
            "info": "Pulsador de activación del sistema motor",
            "readonly": true
          },
          "position": {
            "x": 824,
        ...
        {
          "id": "dbc791a4-3bff-4f17-8336-d805e29984e3",
          "type": "basic.info",
          "data": {
            "info": "Por seguridad , en caso de que los dos IR encuentren un obstáculo resetean el biestable que activa el motor , y este se para",
            "readonly": true
          },
          "position": {
            "x": 416,
        ...
        {
          "id": "109ff0a0-42b2-4ec5-8ab0-4e42314d0ad6",
          "type": "basic.info",
          "data": {
            "info": "Tabla que indica en qué sentido ha de girar el motor según las señales que lleguen desde los IR",
            "readonly": true
          },
          "position": {
            "x": 920,
        ...
        {
          "id": "e96a9277-5e60-4db4-ac8d-b7b765ebb53d",
        ...
        {
          "id": "51556ed0-ae8c-4135-9f87-898ee8d2a42d",
        ...
        {
          "id": "afcbdb7b-11d5-498b-aa56-9941d36b1339",
          "type": "basic.info",
          "data": {
            "info": "Biestable que controla si el motor está parado o en marcha. Se pone en marcha solamente mediante el botón de activación . Y se para solamente si los dos IR reciben señal simultanea",
            "readonly": true
          },
          "position": {
            "x": 1176,
        ...
        {
          "id": "fcd7a591-1285-4fee-9768-a6e3444bf282",
          "type": "basic.info",
          "data": {
            "info": "Salida hacia el motor",
            "readonly": true
          },
          "position": {
            "x": 1304,
      ...
      "wires": [
        {
          "source": {
            "block": "72b9e91b-e177-4e8a-8ce0-6537fd8b64ad",
            "port": "90b11c57-5dc4-4363-b14c-b4ec485e0a2b"
          },
          "target": {
            "block": "cf85efb3-08a4-4eba-9a6a-9276261c84c3",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "e437bc3e-9d3e-442d-89fa-85d9ee2fcc42",
            "port": "out"
          },
          "target": {
            "block": "ed304a68-122e-4cf2-94e7-519965b9692e",
            "port": "3ae2d46d-7981-497a-899f-b60bfae0f43e"
          }
        },
        {
          "source": {
            "block": "eed2fa7f-13ab-4e78-8f37-f7a49727f0e2",
            "port": "out"
          },
          "target": {
            "block": "780beb07-4953-4178-b1ab-f0740d6e29fe",
            "port": "3ae2d46d-7981-497a-899f-b60bfae0f43e"
          }
        },
        {
        ...
        },
        {
          ...
          "target": {
            "block": "29e34ec0-a264-498f-bc20-861d1f3bbf6d",
        ...
        },
        {
          ...
          "target": {
            "block": "7a68a6dc-34ba-419d-baf3-54fc54eb8542",
        ...
        {
          "source": {
            "block": "85d2d262-ffe9-4fd3-8b52-6a2d31d341f5",
            "port": "memory-out"
          },
          "target": {
            "block": "7a68a6dc-34ba-419d-baf3-54fc54eb8542",
        ...
        {
          "source": {
            "block": "c3b8ed1f-6214-4323-ac2e-188faad92ab7",
            "port": "out"
          },
          "target": {
            "block": "cc5e77d6-62ec-4a75-a8a9-f6a86b714759",
            "port": "3ae2d46d-7981-497a-899f-b60bfae0f43e"
          },
          "vertices": []
        },
        ...
        {
          "source": {
            "block": "8c87fb3a-0dee-4340-b8a4-6d069f428799",
