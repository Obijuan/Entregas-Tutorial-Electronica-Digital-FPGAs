{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "a4dda975-2308-4d8f-9302-27eb22b52cd0",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "e25fd704-39bd-4bbd-b7a0-a1eb608dbc83",
          "type": "basic.input",
          "data": {
            "name": "Pulsador",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1>Tutorial 10 #FPGAwars</h1>\n<B>Ejercicio 10.2</B>: Hacer una barrera de acceso a un recinto, con un servo y cartón. Al apretar un pulsador se levanta, y al sortarlo se cierra\n\nVideo Demo: https://www.youtube.com/watch?v=74imZ80poBk",
            "readonly": true
          },
          "position": {
            "x": 0,
        ...
        {
          "id": "b7ab5465-696f-4afc-bebe-ab0e1060d10d",
      ...
      "wires": [
        {
          "source": {
            "block": "e25fd704-39bd-4bbd-b7a0-a1eb608dbc83",
            "port": "out"
          },
          "target": {
            "block": "b7ab5465-696f-4afc-bebe-ab0e1060d10d",
        ...
        },
        {
          ...
          "target": {
            "block": "a4dda975-2308-4d8f-9302-27eb22b52cd0",
            "port": "in"
          }
        }
      ]
