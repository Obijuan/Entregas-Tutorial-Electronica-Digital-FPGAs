  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "4bf4a217-c0a4-4d87-a8fe-84f36c6a6847",
          "type": "basic.code",
          "data": {
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<B>Ejercicio 4 - Josep Montoliu Sanahuja</B>\n\nAprovecho la parte principal del servo que recibe las posiciones como número de 8 bits para crear un movimiento de\nservo de 4 posiciones. Las posiciones se cambian automáticamente mediante un contador de 2 bits que se\nincrementa a una frecuencia de 1Hz (1 vez por segundo)",
            "readonly": true
          },
          "position": {
            "x": -1424,
      ...
      "wires": [
        {
          "source": {
            "block": "4bf4a217-c0a4-4d87-a8fe-84f36c6a6847",
            "port": "o"
          },
          "target": {
