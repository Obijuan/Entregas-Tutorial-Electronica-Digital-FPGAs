{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "3179a270-2211-4b23-8621-a5e104d7a4ec",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "02ea29b2-aecc-48e1-a761-cb3d33a4c840",
          "type": "basic.output",
          "data": {
            "name": "out",
            "pins": [
        ...
        {
          "id": "212a49eb-fe3f-44f7-982e-6890404f6209",
        ...
        {
          "id": "5205236a-df25-4e48-8250-7b3511446d28",
          "type": "basic.info",
          "data": {
      ...
      "wires": [
        {
          "source": {
            "block": "212a49eb-fe3f-44f7-982e-6890404f6209",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "3179a270-2211-4b23-8621-a5e104d7a4ec",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "02ea29b2-aecc-48e1-a761-cb3d33a4c840",
            "port": "in"
          }
        }
      ]
