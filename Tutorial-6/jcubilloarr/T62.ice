{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "4ce85885-283e-433d-84a7-eda6fe49f615",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "55eed263-c1f3-46c9-8424-98bf78ee2d86",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "016481cc-df80-47b8-b065-55d330f3b5ac",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "b94592db-d417-414f-a840-3a8d62f06b29",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "5046b8fc-057a-4fb5-b7f3-a25025235b7f",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "41e3fcba-7722-4a66-ae8b-2e406111d399",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "79097b46-0165-49de-bc19-938bf309795b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "e43763d3-5042-4eac-8c4a-52746a2606c5",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "92949af7-cc09-4f8d-83d6-cdd2441f072c",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h2 style=\"color: #2e6c80;\">TUT 6. Ejercicio 2 </h2>\r\n<p>Hacer un circuito digital en el que los LEDs pares de la icezum Alhambra parpadeen a una velocidad de 4Hz y los impares a 1Hz. </p>\r\n<p><em>J.Cubillo</em></p>",
            "readonly": true
          },
          "position": {
            "x": 144,
        ...
        {
          "id": "688e4969-fbe5-41c9-afe9-1595b846de72",
      ...
      "wires": [
        {
          "source": {
            "block": "92949af7-cc09-4f8d-83d6-cdd2441f072c",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "016481cc-df80-47b8-b065-55d330f3b5ac",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "4ce85885-283e-433d-84a7-eda6fe49f615",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "79097b46-0165-49de-bc19-938bf309795b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "5046b8fc-057a-4fb5-b7f3-a25025235b7f",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "688e4969-fbe5-41c9-afe9-1595b846de72",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "55eed263-c1f3-46c9-8424-98bf78ee2d86",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "b94592db-d417-414f-a840-3a8d62f06b29",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "41e3fcba-7722-4a66-ae8b-2e406111d399",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "e43763d3-5042-4eac-8c4a-52746a2606c5",
            "port": "in"
          },
          "vertices": [
            {
