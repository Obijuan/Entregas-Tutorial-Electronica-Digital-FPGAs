  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "f759f7ef-26bb-424c-b45a-61ab1b42dcfe",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "393ebda1-fa0e-4d31-8313-278029bee70b",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "6e0d49f7-76b8-4300-bdae-bbd9e95e463d",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "580fde46-9aec-4e60-aeb2-7dff06c373cf",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "49f0cbbe-7039-4282-9843-c443631de123",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "**Javier Puche Alosete**\n\nTutorial 6. Ejercicio 2\n\nHacer un circuito digital que haga parpadear los LEDs  pares de la icezum Alhambra parpadeen a una velocidad de 4Hz y los impares a 1Hz",
            "readonly": true
          },
          "position": {
            "x": -112,
        ...
        {
          "id": "a7c7cfe7-f44a-4ae5-bd31-918183207293",
      ...
      "wires": [
        {
          "source": {
            "block": "49f0cbbe-7039-4282-9843-c443631de123",
        ...
        },
        {
          ...
          "target": {
            "block": "f759f7ef-26bb-424c-b45a-61ab1b42dcfe",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "a7c7cfe7-f44a-4ae5-bd31-918183207293",
        ...
        },
        {
          ...
          "target": {
            "block": "393ebda1-fa0e-4d31-8313-278029bee70b",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "6e0d49f7-76b8-4300-bdae-bbd9e95e463d",
            "port": "in"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "580fde46-9aec-4e60-aeb2-7dff06c373cf",
            "port": "in"
          },
          "vertices": []
        }
