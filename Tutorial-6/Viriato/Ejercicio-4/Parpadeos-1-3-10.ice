{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "1a088ed1-c513-44bf-8826-ae39e8a2ab03",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "91514ba2-94e4-4d7d-afc4-4767d9eee06a",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "31e90db6-445e-4a1d-bdde-fcc46d3a7db0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "08ec3de4-1d17-4e01-bd9b-2707f6a4b57f",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "04ed6617-e19f-4cd2-a672-834edb7ad18a",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "3035f0f9-1952-4d14-9938-bcfde48d2f34",
        ...
        {
          "id": "6f98d0e1-4220-4bbf-942b-e2b7cabb972f",
        ...
        {
          "id": "2fb90b9e-8d7c-4be3-9c1d-8dbb9e021d01",
      ...
      "wires": [
        {
          "source": {
            "block": "3035f0f9-1952-4d14-9938-bcfde48d2f34",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "91514ba2-94e4-4d7d-afc4-4767d9eee06a",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "1a088ed1-c513-44bf-8826-ae39e8a2ab03",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "6f98d0e1-4220-4bbf-942b-e2b7cabb972f",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "04ed6617-e19f-4cd2-a672-834edb7ad18a",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "2fb90b9e-8d7c-4be3-9c1d-8dbb9e021d01",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "31e90db6-445e-4a1d-bdde-fcc46d3a7db0",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "08ec3de4-1d17-4e01-bd9b-2707f6a4b57f",
            "port": "in"
          }
        }
      ]
