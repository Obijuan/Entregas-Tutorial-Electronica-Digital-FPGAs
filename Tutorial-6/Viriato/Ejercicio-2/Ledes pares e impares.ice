{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "35753dc6-5528-4373-83c4-ad657c2538a0",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "615e5fa3-3b86-4e43-a225-d21dcb952be3",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "8de9094b-604a-4939-a522-b52673bc3db7",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "ab56a462-09b6-4dd9-88f8-521746b448ad",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "99471d8c-fe3e-4796-878a-c3ea8aff7108",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "64a37a60-414c-4c06-b084-9a0eead5ccbf",
        ...
        {
          "id": "e14e1ba6-4311-4623-bc6c-2ccf91953967",
        ...
        {
          "id": "dcff5eaf-9e48-4804-8440-ca0f71ae1931",
          "type": "basic.info",
          "data": {
            "info": "Los ledes <b>Impares</b> parpadean a <b>1 Hz</b>.\nLos ledes <b>Pares</b> parpadean a <b>4 Hz</b>.",
            "readonly": true
          },
          "position": {
            "x": 392,
      ...
      "wires": [
        {
          "source": {
            "block": "64a37a60-414c-4c06-b084-9a0eead5ccbf",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "615e5fa3-3b86-4e43-a225-d21dcb952be3",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "35753dc6-5528-4373-83c4-ad657c2538a0",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "8de9094b-604a-4939-a522-b52673bc3db7",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "e14e1ba6-4311-4623-bc6c-2ccf91953967",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "ab56a462-09b6-4dd9-88f8-521746b448ad",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "99471d8c-fe3e-4796-878a-c3ea8aff7108",
            "port": "in"
          }
        }
      ]
