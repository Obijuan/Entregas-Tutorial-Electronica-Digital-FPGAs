{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "fafe635d-dd89-4eb2-9b9e-9873e2cb276a",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "5a1879bc-5f29-475d-8087-4dcb20968608",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "6acfddd2-bbbb-420a-927f-80e0b5cd4f90",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "673fe3de-43db-4b39-9212-4fc53f8cc4e4",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "pins": [
        ...
        {
          "id": "ac0d68b6-c21c-4fc0-a525-b0001def8470",
        ...
        {
          "id": "d3f0b3cb-1c36-4f39-a16d-adb400a17c8a",
        ...
        {
          "id": "ffd81f00-0283-4f27-be3c-6bbf341d8b73",
        ...
        {
          "id": "712f91ce-cf0e-4a6a-adf6-38fc4f382295",
      ...
      "wires": [
        {
          "source": {
            "block": "ac0d68b6-c21c-4fc0-a525-b0001def8470",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "fafe635d-dd89-4eb2-9b9e-9873e2cb276a",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "d3f0b3cb-1c36-4f39-a16d-adb400a17c8a",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "5a1879bc-5f29-475d-8087-4dcb20968608",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "ffd81f00-0283-4f27-be3c-6bbf341d8b73",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "6acfddd2-bbbb-420a-927f-80e0b5cd4f90",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "712f91ce-cf0e-4a6a-adf6-38fc4f382295",
            "port": "70887b0b-826c-4150-a873-605b77da8272"
          },
          "target": {
            "block": "673fe3de-43db-4b39-9212-4fc53f8cc4e4",
            "port": "in"
          }
        }
      ]
