{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "cfd8ef66-6b71-4d80-8a5e-a1a8343884f9",
          "type": "basic.output",
          "data": {
            "name": "Servo_ojos",
            "pins": [
        ...
        {
          "id": "fb0867d3-1b84-4fed-8d90-3e8f9e22c6fc",
          "type": "basic.output",
          "data": {
            "name": "Motor-right",
            "pins": [
        ...
        {
          "id": "52fe340e-3dd3-458d-a531-fd0887540acf",
          "type": "basic.output",
          "data": {
            "name": "Motor-left",
            "pins": [
        ...
        {
          "id": "0a3a3e79-209c-415c-bee1-2f8e6c0de07e",
          "type": "basic.memory",
          "data": {
            "name": "Movimientos",
            "list": "11 // Adelante\n01 // Giro Derecha\n11 // Adelante\n10 // Giro Izquierda",
        ...
        {
          "id": "c2250475-aa1c-4d8e-8bce-642f57f11708",
        ...
        {
          "id": "6e2135c2-62cc-4c29-84db-026a8b3b8e8e",
        ...
        {
          "id": "c3f6bb3e-5f62-40b4-ac44-6c96d19803a2",
        ...
        {
          "id": "7533d26a-c190-4ed5-954e-fdb4fec1d35b",
        ...
        {
          "id": "1cdb7d08-10c8-416c-83a8-fc8bfdab2f3a",
          "type": "basic.info",
          "data": {
            "info": "Servo que controla el giro de la torreta donde va montado el sensor de ultrasonidos.",
            "readonly": true
          },
          "position": {
            "x": 848,
        ...
        {
          "id": "586b0cd2-9f90-4b1e-8f32-866d2375c29c",
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n## Tutorial 31 :\n## Robot detector de obstáculos mediante sensor de ultrasonidos :\n\nCon este programa lo que se pretende es dotar a un robot de tres movimientos ( Adelante , Giro a Izquierda y Giro a Derecha ) que dependerán de las lecturas que reciba de un sensor de ultrasonidos con respecto a posibles obstáculos que se encuentre a su alrededor , fijando una distancia mínima a los mismos .\n\nDicha distancia mínima en nuestro caso se ha establacido en 20 cms\n\n### Lógica del funcionamiento :\n\n> En caso de no encontrar obstáculo a menos de 20 cms en cualquiera de las lecturas a derecha o izquierda , el robot mueve ambas ruedas y AVANZA\n\n> En caso de encontrar un obstáculo a menos de 20 cms a la DERECHA , GIRA a IZQUIERDA\n\n> En caso de encontrar un obstáculo a menos de 20 cms a la IZQUIERDA , GIRA a DERECHA",
            "readonly": true
          },
          "position": {
            "x": -464,
        ...
        {
          "id": "fb1d8c88-fab9-486b-b72f-6b6d960534a7",
        ...
        {
          "id": "f07caa51-1031-4763-8b59-2a37294d4c61",
        ...
        {
          "id": "21f8f723-86af-4b87-ae1d-7b881070203c",
        ...
        {
          "id": "9f0fa366-c84c-47da-9196-2196fdcda49f",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "c2250475-aa1c-4d8e-8bce-642f57f11708",
        ...
        },
        {
          ...
          "target": {
            "block": "cfd8ef66-6b71-4d80-8a5e-a1a8343884f9",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "6e2135c2-62cc-4c29-84db-026a8b3b8e8e",
            "port": "24528741-1a70-4a35-b18c-7faff7aff3e2"
          },
          "target": {
            "block": "52fe340e-3dd3-458d-a531-fd0887540acf",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "fb0867d3-1b84-4fed-8d90-3e8f9e22c6fc",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "7533d26a-c190-4ed5-954e-fdb4fec1d35b",
        ...
        },
        {
          ...
          "target": {
            "block": "c3f6bb3e-5f62-40b4-ac44-6c96d19803a2",
        ...
        {
          "source": {
            "block": "0a3a3e79-209c-415c-bee1-2f8e6c0de07e",
            "port": "memory-out"
          },
          "target": {
            "block": "c3f6bb3e-5f62-40b4-ac44-6c96d19803a2",
