  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "790c6f3c-964b-462e-afbd-5e855a60ecc8",
          "type": "basic.input",
          "data": {
            "name": "On/OFF",
            "pins": [
        ...
        {
          "id": "ef548a4c-7b48-47d4-97c9-59ec4e356fb4",
          "type": "basic.output",
          "data": {
            "name": "Alarma",
            "pins": [
        ...
        {
          "id": "28a71b19-fe8d-42dc-bca5-bf38fa18c216",
          "type": "basic.memory",
          "data": {
            "name": "",
            "list": "00000000\n00001111 // Encendemos Led0 : Led3\n11110000 // Encendemos Led4 : Led7\n00000000",
            "local": false,
            "format": 10
          },
          "position": {
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n## Tutorial 31 :\n## Avisador de Distancia Limite : Comparación de distancia medida con una previamente fijada en microsegundos y aviso luminoso y acústico en caso de rebasarla\n\nCon este programa lo que se pretende es medir una distancia a un objeto mediante el sensor de ultrasonidos cada T_msec milisegundos. \n\nUna vez medida , los microsegundos de la lectura de los dos contadores se guardan en un registro de 16 bits y se compara con una distancia límite previamente almacenada en el programa , guardada en su equivalente en microsegundos empleados por la onda sonora en rebotar contra el objeto y volver, viajando a 340 m/s.\n\nPor ejemplo , si queremos fijar una distancia límite al obstáculo de 20 cms ( 200 mm ) , los microsegundos equivalentes serán 1176 microsec\n\nEn caso de que la distancia medida sea inferior o igual al límite , se activa una alarma sonora y se encienden los Leds del LED0 al LED3\n\nEn caso contrario , es decir , si la distancia medida es superior al límite fijado , se apaga la alarma y se encienden los Leds del LED4 al LED7",
            "readonly": true
          },
          "position": {
            "x": -3160,
        ...
        {
          "id": "e63096f0-0553-40c2-b144-0e9fc8c04621",
        ...
        {
          "id": "4e3d1f55-2bd4-4826-993a-afe52f3fb6ae",
        ...
        {
          "id": "6092991f-be4e-4047-aded-f0932caf3e28",
        ...
        {
          "id": "667919a2-6888-4fa3-a06d-3a7f52e6bc23",
          "type": "basic.info",
          "data": {
            "info": "Realizamos mediciones de distancia al objeto cada 250 milisegundos , por ejemplo",
            "readonly": true
          },
          "position": {
            "x": -2960,
        ...
        {
          "id": "8a160a4b-c40b-4659-83b4-74c6d5eef827",
        ...
        {
          "id": "d17fec5d-0892-423e-bc25-8f367ae03013",
          "type": "basic.info",
          "data": {
            "info": "Boton ON/OFF que permite encender y apagar las mediciones de distancia del sensor.\nEn caso de estar a cero , no se envía ninguna señal al TRIGGER y por tanto el sensor de ultrasonidos no se activa",
            "readonly": true
          },
          "position": {
            "x": -2648,
        ...
        {
          "id": "af309e1d-4fda-4e1d-9c2f-35868a478ec7",
          "type": "basic.info",
          "data": {
            "info": "1176 microsegundos equivalen a una distancia al objeto de 20 cms o 200 mm",
            "readonly": true
          },
          "position": {
            "x": -2040,
        ...
        {
          "id": "3b7c7ffa-ef25-4da9-8c18-0b050e5d0e75",
          "type": "basic.info",
          "data": {
            "info": "Registro de 16 bits , donde guardamos la información de microsegundos al obstaculo que nos envían los dos contadores del bloque Sensor de Ultrasonidos HCSR-04 ",
            "readonly": true
          },
          "position": {
            "x": -2224,
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "e63096f0-0553-40c2-b144-0e9fc8c04621",
        ...
        },
        {
          ...
          "target": {
            "block": "4e3d1f55-2bd4-4826-993a-afe52f3fb6ae",
        ...
        {
          "source": {
            "block": "28a71b19-fe8d-42dc-bca5-bf38fa18c216",
            "port": "memory-out"
          },
          "target": {
            "block": "e63096f0-0553-40c2-b144-0e9fc8c04621",
        ...
        },
        {
          ...
          "target": {
            "block": "6092991f-be4e-4047-aded-f0932caf3e28",
        ...
        },
        {
          ...
          "target": {
            "block": "ef548a4c-7b48-47d4-97c9-59ec4e356fb4",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "8a160a4b-c40b-4659-83b4-74c6d5eef827",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
        ...
        {
          "source": {
            "block": "790c6f3c-964b-462e-afbd-5e855a60ecc8",
            "port": "out"
          },
          "target": {
            "block": "8a160a4b-c40b-4659-83b4-74c6d5eef827",
