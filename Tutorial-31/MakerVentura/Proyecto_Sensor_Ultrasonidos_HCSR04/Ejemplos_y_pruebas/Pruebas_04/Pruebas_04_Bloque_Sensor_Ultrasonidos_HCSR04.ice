  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "66a29f08-d3d9-43bf-8cdf-4cc4ab2c699e",
          "type": "basic.output",
          "data": {
            "name": "leds",
            "range": "[7:0]",
        ...
        {
          "id": "81d0e3c7-eb08-4555-9b2a-f8cc1e83d8d4",
          "type": "basic.input",
          "data": {
            "name": "Selector",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n## Tutorial 31 :\n## Pruebas_04_Sensor_Ultrasonidos_HCSR04 : Control Sensor Ultrasonidos tipo HCSR04 con pulsos periódicos utilizando el bloque Sensor US HC SR-04. Mostramos la inforción de los dos contadores por los 8 leds internos de la tarjeta Alhambra . Mediante un multiplexor seleccionamos el contador A o el contador B\n\nCon este programa 04 , utilizando el bloque **Sensor de ultrasonidos HCSR04** , dejamos que dos contadores de 8 bits almacenen el número de microsegundos que nos entrega el bloque y los envien a dos registros separados de 8 bits que almacenan la información recibida y la muestran por los 8 leds internos de la tarjeta Alhambra según se seleccione un registro u otro mediante el multiplexor y un interruptor selector externo.\n\n",
            "readonly": true
          },
          "position": {
            "x": -3128,
        ...
        {
          "id": "e6245987-f902-4142-b3d0-06d528fe412c",
        ...
        {
          "id": "561b73ed-2954-40de-ba3e-e076a6a735b0",
        ...
        {
          "id": "8b1084fe-23ff-4d3e-9ee5-76f054862bf7",
          "type": "89d2342d9664348db3e70e823cacbc8eb24ea3d0",
          "position": {
            "x": -1216,
            "y": 64
        ...
        {
          "id": "3a8ff2b4-341b-4193-ace2-cbdea87b18d6",
        ...
        {
          "id": "868db441-1003-400d-aa7e-b85ca547ffb1",
          "type": "basic.info",
          "data": {
            "info": "Registro de 8 bits que almacena la información en microsegundos del Contador A , más significativo",
            "readonly": true
          },
          "position": {
            "x": -1256,
        ...
        {
          "id": "789067f9-0cdf-4a38-808f-9d9bc2db4cde",
          "type": "basic.info",
          "data": {
            "info": "Registro de 8 bits que almacena la información en microsegundos del Contador B , menos significativo",
            "readonly": true
          },
          "position": {
            "x": -1280,
        ...
        {
          "id": "e3a80c8f-af05-4786-884e-6a3789cba602",
          "type": "basic.info",
          "data": {
            "info": "Medición de distacia periódica cada 1000 milisegundos , por ejemplo",
            "readonly": true
          },
          "position": {
            "x": -1992,
        ...
        {
          "id": "c23d936b-e889-46fb-9e76-75e5859981d4",
          "type": "basic.info",
          "data": {
            "info": "Selector del Contador A o Contador B",
            "readonly": true
          },
          "position": {
            "x": -968,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "e6245987-f902-4142-b3d0-06d528fe412c",
        ...
        },
        {
          ...
          "target": {
            "block": "561b73ed-2954-40de-ba3e-e076a6a735b0",
        ...
        },
        {
          ...
          "target": {
            "block": "8b1084fe-23ff-4d3e-9ee5-76f054862bf7",
            "port": "42b35cc2-aa64-4e66-be42-169958246799"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "3a8ff2b4-341b-4193-ace2-cbdea87b18d6",
            "port": "bf25756a-65a4-4b09-915d-494010d6f4ff"
          },
          "target": {
            "block": "66a29f08-d3d9-43bf-8cdf-4cc4ab2c699e",
            "port": "in"
          },
          "size": 8
        },
        ...
        {
          "source": {
            "block": "81d0e3c7-eb08-4555-9b2a-f8cc1e83d8d4",
            "port": "out"
          },
          "target": {
            "block": "3a8ff2b4-341b-4193-ace2-cbdea87b18d6",
