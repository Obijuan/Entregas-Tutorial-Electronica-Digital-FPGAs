{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "98033fc7-94e8-4a29-9379-931b79ebabc0",
          "type": "basic.output",
          "data": {
            "name": "",
            "pins": [
        ...
        {
          "id": "cc7161f8-9474-4d6a-bee4-548fb891006b",
          "type": "basic.constant",
          "data": {
            "name": "",
            "value": "500",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "# MakerVentura :\n## Tutorial 31 :\n## Pruebas_03_Sensor_Ultrasonidos_HCSR04 : Control Sensor Ultrasonidos tipo HCSR04 con pulsos periódicos utilizando el bloque Sensor US HC SR-04\n\nCon este programa enviamos pulsos periódicos de 10 microsegundos por la patilla **TRIGGER** del senspr para que active lo active , de forma que la patilla **ECHO** del mismo se active y se ponga a \"1\" , comenzando a medir el tiempo desde que envía un tren de 8 pulsos de eco hacia el exterior y dicho tren de ondas de sonido vuelve a llegar de nuevo al sensor , momento en que dicha patilla **ECHO** vuelve a ponerse a \"0\" .\nDurante ese periodo de tiempo en que **ECHO** está activa en ALTO , dejamos que dos contadores de 8 bits almacenen el número de microsegundos que han pasado y los envien al scripcomunicator para verlos en decimal en pantalla y hacer la conversión a distancia en milímetros.\n\nSi Vsonido = 340 m/s    -->  distancia (mm) = 0.17 x tiempo(microseg)\n\nLa novedad en esta prueba es que toda la circuitería de control del sensor de ulrasonidos HCSR04 mediante pulsos periódicos la he convertido en un bloque de código.\n\n**El Bloque de código dispone de :**\n\nUna salida Trigger que hay que conectar a la correspondiente entrada TRIGGER del sensor , \n\nUna entrada ECHO que se conectará a la salida ECHO del sensor\n\nUna salida Out[15:0] de 16 bits por donde se envía al exterior la lectura de los dos contadores de microsegundos.\n\nUna salida OK , que manda un TIC cuando el sensor ha terminado de realiza la medición .\n\nUna salida OV , que envía un TIC en caso de que el contador más significativo se desborde y vuelva a cero .\n\nUna entrada de parámetro T_msec donde se puede establecer el periodo de mediciones de distancia en milisegundos\n",
            "readonly": true
          },
          "position": {
            "x": -3120,
        ...
        {
          "id": "f65dcb72-8721-4ca9-86c3-d9d8dccf63b2",
        ...
        {
          "id": "b7e8305e-0db8-45c1-9646-de82c0d4b4e3",
      ...
      "wires": [
        ...
        {
          "source": {
            "block": "f65dcb72-8721-4ca9-86c3-d9d8dccf63b2",
            "port": "1cb167a4-9e2a-416b-803e-da7b6151eaa5"
          },
          "target": {
            "block": "98033fc7-94e8-4a29-9379-931b79ebabc0",
            "port": "in"
          }
        },
        {
          "source": {
            "block": "b7e8305e-0db8-45c1-9646-de82c0d4b4e3",
        ...
        {
          "source": {
            "block": "cc7161f8-9474-4d6a-bee4-548fb891006b",
            "port": "constant-out"
          },
          "target": {
            "block": "b7e8305e-0db8-45c1-9646-de82c0d4b4e3",
