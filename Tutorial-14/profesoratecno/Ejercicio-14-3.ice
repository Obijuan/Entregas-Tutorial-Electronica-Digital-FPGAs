  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "24b3b0a5-251a-478e-b479-1761b465c759",
        ...
        {
          "id": "bb485fdf-3ced-4dff-b243-726120855cbf",
          "type": "basic.info",
          "data": {
            "info": "<B>OJOS</B>",
            "readonly": true
        ...
        {
          "id": "ac3b40b3-8651-4782-9b37-aa20abfb78d3",
          "type": "basic.info",
          "data": {
            "info": "<B>SONIDO</B>",
            "readonly": true
        ...
        {
          "id": "9807cc73-4309-449a-8e27-3a84cbbdba68",
          "type": "basic.info",
          "data": {
            "info": "**Ejercicio 14.3**: (5 Bitpoints). **Franky en modo automático y manual**\n\nFranky tiene los **siguientes elementos** que podemos controlar:\n* Un **servo** que le permite mirar hacia un lado u otro (CUELLO)\n* **Dos leds externos** para emitir los \"rayos lásers\" (DOS OJOS) -> Para la **emisión de los rayos láser**, ambos LEDs parpadean a una frecuencia de **10Hz**.\n* Un **zumbador** para el sonido de los rayos lásers (SONIDO) -> El **sonido de los lásers** es un **tono de 1Khz** activado a una frecuencia de **10Hz**\n\n",
            "readonly": true
          },
          "position": {
            "x": -472,
        ...
        {
          "id": "ef83d528-0ad2-4eac-ae83-5ccaf47e982e",
          "type": "basic.info",
          "data": {
            "info": "**Franky** debe funcionar en **dos modos**:\n\n<B>MODO AUTOMÁTICO.-</B>según la posición del **interruptor externo 1 = SWITCH SELECT = 0**.  \nFranky gira su cabeza de lado a lado, estando **2 segundos** en cada\nlado. En uno de los dos lados (el que se quiera), emitirá una ráfaga de rayos láser\npor sus ojos, y emitirá el sonido correspondiente (descrito arriba)\nCuando Franky está en modo automático, **NO HARÁ** caso de los controles manuales: Pulsador e interruptor 2\n\n<B>MODO MANUAL.-</B> según la posición del **interruptor externo 1 = SWITCH SELECT = 1**, \nla posición del cuello está controlada por el **interruptor externo 2 (DRCH/IZQ)**, y \ncada vez que se apriete un **pulsador externo**, se emitirán las ráfagas de los lásers y \nsu correspondiente sonido",
            "readonly": true
          },
          "position": {
            "x": -464,
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "24b3b0a5-251a-478e-b479-1761b465c759",
            "port": "5898179a-7390-429b-ac3c-b7a0df673610"
          },
          "vertices": [
            {
