{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "7a94022a-3b69-4029-8029-e02b423f17f4",
          "type": "basic.output",
          "data": {
            "name": "Servo",
            "pins": [
        ...
        {
          "id": "ba3f0f90-b24d-4da7-9c58-0a9bb28df19f",
          "type": "basic.input",
          "data": {
            "name": "IR",
            "pins": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "<h1 align=\"center\">TUTORIAL 16</h1>\n<h2 align=\"center\">EJERCICIO 2</h2>\n\n<h3 align=\"center\">BARRERA AUTOMÁTICA</h3>\n<h3 align=\"center\">Diseñar un circuito digital que suba una barrera cuando el sensor de IR detecta la\npresencia de un coche. Se cierra cuando no se detecta nada. El circuito todavía no temporiza nada, ni almacena información. Simplemente sube o baja la barrera en función del estado del sensor IR</h3>",
            "readonly": true
          },
          "position": {
            "x": -3240,
        ...
        {
          "id": "14da819d-43e6-48b5-9496-b267ec1dd846",
        ...
        {
          "id": "d09c5fbf-92ac-4aa4-9cca-ccb06090157c",
      ...
      "wires": [
        {
          "source": {
            "block": "14da819d-43e6-48b5-9496-b267ec1dd846",
            "port": "52f2f09c-75c4-49b9-bb9c-20000df9e5cc"
          },
          "target": {
            "block": "7a94022a-3b69-4029-8029-e02b423f17f4",
            "port": "in"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "ba3f0f90-b24d-4da7-9c58-0a9bb28df19f",
            "port": "out"
          },
          "target": {
            "block": "d09c5fbf-92ac-4aa4-9cca-ccb06090157c",
