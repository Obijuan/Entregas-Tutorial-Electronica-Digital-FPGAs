  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "8fd8c37a-a36a-4bf4-95bf-91ac9fc3528e",
          "type": "basic.output",
          "data": {
            "name": "zumbador",
            "pins": [
        ...
        {
          "id": "eecfae64-f7f8-44bc-a40b-4e291a5215e5",
          "type": "basic.output",
          "data": {
            "name": "Test_led",
            "pins": [
        ...
        {
          "id": "d4f8501f-67d3-4340-8d7d-0fef94a5a0c9",
          "type": "basic.constant",
          "data": {
            "name": "msec",
            "value": "10",
        ...
        {
          "id": "45cef24b-defa-4a9b-861f-50f24332b579",
          "type": "basic.constant",
          "data": {
            "name": "Frecuencia",
            "value": "1400",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "**MakerVentura :**\n\n**Tutorial 27 :**\n\n**Ejercicio 27.1:** (5 Bitpoints). Contador de vueltas de un spinner, de 0 a 999\n\nCrear un circuito capaz de contar las **vueltas de un spinner**. Debe tener **3 dígitos decimales**, por lo que  \ncontará desde **000** hasta **999**. Para detectar los brazos del spinner se usará **un sensor de infrarrojos IR**.  \nCada vez que uno de los brazos del spinner sea detectado por el IR se emitirá un **pitido de 10ms**  \nSe colocará un **display de 7 segmentos** para ver el dígito del contador seleccionado: unidades, decenas o  \ncentenas. Tendrá un **pulsador de reset** para iniciar la cuenta a cero\n\n\n\n**Nota : He introducido algún cambio para utilizar la salida de doble display de ánodo común de la que dispongo en estos momentos en casa . El contador de vueltas que he programado cuenta de 0000 a 9999 . Uso dos bloques de programación de 00 a 99 : Uno se encarga de llevar el cómputo de las **UNIDADES** y las **DECENAS , mientras que el otro contabiliza las **CENTENAS** y los **MILLARES** . Mediante el interruptor denominado **SELECTOR** , se elige el doble contador a mostrar por el display doble : UNID/DEC  o CENT/MILL . Finalmente , cada vez que se desborda uno de los contadores , se emite una señal luminosa por tiempo definido por uno de los leds internos de la placa**",
            "readonly": true
          },
          "position": {
            "x": -1520,
        ...
        {
          "id": "066d5930-4d70-43c0-9559-46c5ed5095ee",
        ...
        {
          "id": "997d7595-68e1-4dd1-93e8-a66f2fb5589a",
        ...
        {
          "id": "6b92c9cc-475e-4cdf-ac8b-114484c52bdd",
        ...
        {
          "id": "0ba8c33b-471d-4880-b40e-70c2da8b76ff",
          "type": "basic.info",
          "data": {
            "info": "Parte del circuito que detecta los tics emitidos por el sensor IR y emite durante 10 mseg dos señales : Un destello luminoso y un pitido",
            "readonly": true
          },
          "position": {
            "x": -1408,
        ...
        {
          "id": "9aa193e7-54aa-4781-8209-64278cc89c6b",
          "type": "basic.info",
          "data": {
            "info": "Botón de Reset",
            "readonly": true
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "066d5930-4d70-43c0-9559-46c5ed5095ee",
            "port": "61d11f03-6fbc-4467-a947-d546fa6f6429"
          }
        },
        {
          "source": {
            "block": "d4f8501f-67d3-4340-8d7d-0fef94a5a0c9",
            "port": "constant-out"
          },
          "target": {
            "block": "066d5930-4d70-43c0-9559-46c5ed5095ee",
        ...
        },
        {
          ...
          "target": {
            "block": "eecfae64-f7f8-44bc-a40b-4e291a5215e5",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "997d7595-68e1-4dd1-93e8-a66f2fb5589a",
            "port": "664caf9e-5f40-4df4-800a-b626af702e62"
          },
          "target": {
            "block": "8fd8c37a-a36a-4bf4-95bf-91ac9fc3528e",
            "port": "in"
          }
        },
        {
        ...
        {
          "source": {
            "block": "6b92c9cc-475e-4cdf-ac8b-114484c52bdd",
        ...
        {
          "source": {
            "block": "45cef24b-defa-4a9b-861f-50f24332b579",
            "port": "constant-out"
          },
          "target": {
            "block": "6b92c9cc-475e-4cdf-ac8b-114484c52bdd",
