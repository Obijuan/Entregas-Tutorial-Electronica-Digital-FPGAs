{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "9cdf3db4-97a6-48db-9275-8aebe7c39208",
          "type": "basic.input",
          "data": {
            "name": "Mensaje",
            "pins": [
        ...
        {
          "id": "3fca4d5c-3134-4432-a026-568a1aba8103",
          "type": "basic.input",
          "data": {
            "name": "Reset",
            "pins": [
        ...
        {
          "id": "93d64ff8-d44c-466c-a5ed-65fadf3fcfd3",
          "type": "basic.output",
          "data": {
            "name": "on-off",
            "range": "[1:0]",
        ...
        {
          "id": "4ebb33c2-1972-458f-956c-3acb0caa7788",
          "type": "basic.output",
          "data": {
            "name": "Datos",
            "range": "[6:0]",
        ...
        {
          "id": "e3890029-37f6-4c0c-92c4-ae7834b1c16b",
          "type": "basic.input",
          "data": {
            "name": "Velocidad",
            "pins": [
        ...
        {
          "id": "39fbd32c-b591-4919-a8bc-06930edd5037",
          "type": "basic.constant",
          "data": {
            "name": "mseg",
            "value": "800",
        ...
        {
          "id": "5974c1af-4aff-445e-a340-343f251d58f0",
          "type": "basic.constant",
          "data": {
            "name": "mseg",
            "value": "500",
        ...
        {
          "id": "82ac9c90-f69e-4a28-a262-469a50848897",
          "type": "basic.memory",
          "data": {
            "name": "Sec_dec",
            "list": "1111111 // \n0000100 // G\n1111010 // R\n0001000 // A\n0110001 // C\n1111001 // I\n0001000 // A\n0100100 // S\n1111111 // \n0000001 // O\n1100000 // B\n1111001 // I\n1000011 // J\n1000001 // U\n0001000 // A\n1101010 // N",
        ...
        {
          "id": "30f12bc2-3bad-499e-b228-373aea606557",
          "type": "basic.memory",
          "data": {
            "name": "Sec_dec",
            "list": "1111111 // \n0001100 // Q\n1000001 // U\n0110000 // E\n1111111 // \n0000100 // G\n1111010 // R\n0001000 // A\n1101010 // N\n1000010 // D\n0110000 // E\n1111111 // \n0110000 // E\n1111010 // R\n0110000 // E\n0100100 // S",
        ...
        {
          "id": "e37ba468-8ce0-471b-96d5-0118ac21cc43",
          "type": "basic.memory",
          "data": {
            "name": "Sec_unid",
            "list": "0000100 // G\n1111010 // R\n0001000 // A\n0110001 // C\n1111001 // I\n0001000 // A\n0100100 // S\n1111111 // \n0000001 // O\n1100000 // B\n1111001 // I\n1000011 // J\n1000001 // U\n0001000 // A\n1101010 // N\n1111111 // ",
        ...
        {
          "id": "5829f14f-4ae1-4167-9c6f-a555b29a4b19",
          "type": "basic.memory",
          "data": {
            "name": "Sec_unid",
            "list": "0001100 // Q\n1000001 // U\n0110000 // E\n1111111 // \n0000100 // G\n1111010 // R\n0001000 // A\n1101010 // N\n1000010 // D\n0110000 // E\n1111111 // \n0110000 // E\n1111010 // R\n0110000 // E\n0100100 // S\n1111111 // ",
        ...
        {
          "id": "35daf3a5-ae71-4480-942f-7cfafda99284",
          "type": "basic.constant",
          "data": {
            "name": "Hz",
            "value": "100",
        ...
        {
          "id": "6f90d9d6-a7f7-4b2b-9aeb-ccbfb2bdead3",
        ...
        {
          "id": "271882a3-62a7-438c-8daa-960c7661b168",
        ...
        {
          "id": "f21593ba-6442-4428-b755-7bec910ca972",
        ...
        {
          "id": "7f11932e-d2f1-465a-b306-6d740db21b48",
        ...
        {
          "id": "ef4f56e2-1a23-46a5-9b53-5cac3ec26fc5",
        ...
        {
          "id": "c5368552-a590-4d9d-97f8-ad565d875f83",
        ...
        {
          "id": "5540351f-c506-41d0-9f3f-d739b52622e9",
          "type": "58a77473f9f386aa44d03a891465feef8e5f258f",
          "position": {
            "x": 232,
            "y": -40
        ...
        {
          "id": "8d5b6c08-c3ea-41bb-a530-cc0e63b14cc7",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "70a53527-89dc-4869-8065-0e2d42f3f920",
          "type": "basic.info",
          "data": {
            "info": "Estos son los dos pines que controlan cual de los dos displays está encendido en cada momento",
            "readonly": true
          },
          "position": {
            "x": 1176,
        ...
        {
          "id": "b856e7f6-e132-4ec4-8ffb-b19a02423136",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "30d046cb-59d7-45cb-bfcc-a5060925a6ca",
        ...
        {
          "id": "40193386-b57c-4925-b75c-e1cbfe7fc4d0",
        ...
        {
          "id": "8203c47c-aa18-4dd8-a594-a56c314a9970",
        ...
        {
          "id": "d74f8531-88d8-43ec-a71b-963e6f3a2949",
          "type": "519d315d08b3a8cc1aac53c9d14d2fd81d67033f",
          "position": {
            "x": -408,
            "y": 232
        ...
        {
          "id": "78b0a385-d144-4359-9892-76168810cf8a",
        ...
        {
          "id": "70096809-0027-4986-99a6-b314be3a4ffc",
          "type": "58a77473f9f386aa44d03a891465feef8e5f258f",
          "position": {
            "x": 232,
            "y": 392
        ...
        {
          "id": "e3b74d4a-0227-49cb-b73f-70f81a0350df",
          "type": "58a77473f9f386aa44d03a891465feef8e5f258f",
          "position": {
            "x": 232,
            "y": 480
        ...
        {
          "id": "8b9bc87d-ea08-4ed2-ad1c-25727aa56f58",
          "type": "6137f88e7db33b62c0e6ff259b131bedc0899b72",
          "position": {
            "x": 704,
            "y": 24
        ...
        {
          "id": "15b99bad-b677-4081-8e9f-334b3829f582",
          "type": "basic.info",
          "data": {
            "info": "**MENSAJE 1**",
            "readonly": true
        ...
        {
          "id": "42d094ab-a9c2-403c-b632-78cecacd597a",
          "type": "basic.info",
          "data": {
            "info": "**MENSAJE 2**",
            "readonly": true
        ...
        {
          "id": "8bd36878-00bb-4520-8e75-98368be4efa3",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "891dcd4e-0d71-4a0a-86c6-017f164f323a",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "09b83f7d-9271-48e7-8812-bf091e991b14",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "ba4d612e-d706-4676-8b3b-dd784bd57209",
          "type": "basic.info",
          "data": {
            "info": "**CONTADOR DE 00 a 15**",
            "readonly": true
          },
          "position": {
            "x": -88,
        ...
        {
          "id": "5a472207-8bdd-4ae2-9cf0-d586365b7078",
          "type": "basic.info",
          "data": {
            "info": "**BOTON DE SELECCION DEL MENSAJE A MOSTRAR POR LOS DISPLAYS**",
            "readonly": true
          },
          "position": {
            "x": 504,
      ...
      "wires": [
        {
          "source": {
            "block": "ef4f56e2-1a23-46a5-9b53-5cac3ec26fc5",
            "port": "6d5b8c55-b5f9-49f2-a361-8747165fd44e"
          },
          "target": {
            "block": "93d64ff8-d44c-466c-a5ed-65fadf3fcfd3",
            "port": "in"
          },
          "vertices": [],
          "size": 2
        },
        {
          ...
          "target": {
            "block": "4ebb33c2-1972-458f-956c-3acb0caa7788",
            "port": "in"
          },
          "vertices": [],
          "size": 7
        ...
        {
          "source": {
            "block": "35daf3a5-ae71-4480-942f-7cfafda99284",
            "port": "constant-out"
          },
          "target": {
            "block": "ef4f56e2-1a23-46a5-9b53-5cac3ec26fc5",
        ...
        {
          "source": {
            "block": "e37ba468-8ce0-471b-96d5-0118ac21cc43",
            "port": "memory-out"
          },
          "target": {
            "block": "c5368552-a590-4d9d-97f8-ad565d875f83",
            "port": "c71c44ac-0500-4eb5-9c1c-4ea21cd78377"
          }
        },
        {
          "source": {
            "block": "82ac9c90-f69e-4a28-a262-469a50848897",
            "port": "memory-out"
          },
          "target": {
            "block": "5540351f-c506-41d0-9f3f-d739b52622e9",
            "port": "c71c44ac-0500-4eb5-9c1c-4ea21cd78377"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "3fca4d5c-3134-4432-a026-568a1aba8103",
            "port": "out"
          },
          "target": {
            "block": "30d046cb-59d7-45cb-bfcc-a5060925a6ca",
        ...
        {
          "source": {
            "block": "5974c1af-4aff-445e-a340-343f251d58f0",
            "port": "constant-out"
          },
          "target": {
            "block": "8203c47c-aa18-4dd8-a594-a56c314a9970",
            "port": "136e8d6d-892a-4f14-8d6d-0c5bc6c3e844"
          }
        },
        {
          "source": {
            "block": "39fbd32c-b591-4919-a8bc-06930edd5037",
            "port": "constant-out"
          },
          "target": {
            "block": "d74f8531-88d8-43ec-a71b-963e6f3a2949",
            "port": "136e8d6d-892a-4f14-8d6d-0c5bc6c3e844"
          },
          "vertices": []
        },
        {
          ...
          "target": {
            "block": "40193386-b57c-4925-b75c-e1cbfe7fc4d0",
        ...
        {
          "source": {
            "block": "e3890029-37f6-4c0c-92c4-ae7834b1c16b",
            "port": "out"
          },
          "target": {
            "block": "40193386-b57c-4925-b75c-e1cbfe7fc4d0",
        ...
        {
          "source": {
            "block": "5829f14f-4ae1-4167-9c6f-a555b29a4b19",
            "port": "memory-out"
          },
          "target": {
            "block": "70096809-0027-4986-99a6-b314be3a4ffc",
            "port": "c71c44ac-0500-4eb5-9c1c-4ea21cd78377"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "30f12bc2-3bad-499e-b228-373aea606557",
            "port": "memory-out"
          },
          "target": {
            "block": "e3b74d4a-0227-49cb-b73f-70f81a0350df",
            "port": "c71c44ac-0500-4eb5-9c1c-4ea21cd78377"
          },
          "vertices": []
        },
        {
          "source": {
            "block": "78b0a385-d144-4359-9892-76168810cf8a",
        ...
        {
          "source": {
            "block": "8b9bc87d-ea08-4ed2-ad1c-25727aa56f58",
            "port": "2ebc10bd-3bf7-4bce-b939-f9b920b4255b"
          },
          "target": {
            "block": "ef4f56e2-1a23-46a5-9b53-5cac3ec26fc5",
        ...
        {
          "source": {
            "block": "9cdf3db4-97a6-48db-9275-8aebe7c39208",
            "port": "out"
          },
          "target": {
            "block": "8b9bc87d-ea08-4ed2-ad1c-25727aa56f58",
