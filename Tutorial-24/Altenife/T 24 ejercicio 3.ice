{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "3d78e621-072a-402e-8b04-a41610c35017",
          "type": "basic.output",
          "data": {
            "name": "Display",
            "range": "[6:0]",
        ...
        {
          "id": "9ce9abd8-59ff-49b0-b825-1e776e8eb05b",
          "type": "basic.input",
          "data": {
            "name": "Micros",
            "range": "[3:0]",
        ...
        {
          "id": "7e9972cf-a4dc-42f4-b613-61d2bcdd37f8",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "9a4b9d41-66b7-414a-bdee-e73ab211b9c3",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "842684bd-3aec-48e5-b022-3800058492f8",
          "type": "basic.info",
          "data": {
        ...
        {
          "id": "ccac644d-2d13-4c6d-96fa-7a269f187550",
          "type": "43d62c3cfa18bf98608b244b362ed1668db166b2",
          "position": {
            "x": 408,
            "y": 752
          },
      ...
      "wires": [
        {
          "source": {
            "block": "ccac644d-2d13-4c6d-96fa-7a269f187550",
            "port": "dc9fc02a-b826-4c19-927d-406bbf308ee7"
          },
          "target": {
            "block": "3d78e621-072a-402e-8b04-a41610c35017",
            "port": "in"
          },
          "size": 7
        },
        {
          "source": {
            "block": "9ce9abd8-59ff-49b0-b825-1e776e8eb05b",
            "port": "out"
          },
          "target": {
            "block": "ccac644d-2d13-4c6d-96fa-7a269f187550",
            "port": "49d2f9c4-2d19-41fd-b851-02a3e61ab8b7"
          },
          "size": 4
        }
      ]
  ...
  "dependencies": {
    "43d62c3cfa18bf98608b244b362ed1668db166b2": {
      "package": {
        "name": "Bloque EJ3 T24",
        "version": "0.1",
        "description": "Bloque del ejercicio 3 del T 24",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "dc9fc02a-b826-4c19-927d-406bbf308ee7",
              "type": "basic.output",
              "data": {
                "name": "Display",
                "range": "[6:0]",
            ...
            {
              "id": "49d2f9c4-2d19-41fd-b851-02a3e61ab8b7",
              "type": "basic.input",
              "data": {
                "name": "Micros",
                "range": "[3:0]",
            ...
            {
              "id": "a13b6ac3-c6a6-4b94-92c3-26d59f2378aa",
              "type": "basic.memory",
              "data": {
                "name": "",
                "list": "7e //Ejercicio 3\n30 //del T 24\n6d\n79\n33\n5b\n5f\n70\n7f\n73\n00\n08\n09\n49\n63\n1d",
            ...
            {
              "id": "67455c2b-1187-47e1-9552-af6a75403611",
          ...
          "wires": [
            {
              "source": {
                "block": "a13b6ac3-c6a6-4b94-92c3-26d59f2378aa",
                "port": "memory-out"
              },
              "target": {
                "block": "67455c2b-1187-47e1-9552-af6a75403611",
            ...
            },
            {
              ...
              "target": {
                "block": "dc9fc02a-b826-4c19-927d-406bbf308ee7",
                "port": "in"
              },
              "size": 7
            },
            {
              "source": {
                "block": "49d2f9c4-2d19-41fd-b851-02a3e61ab8b7",
                "port": "out"
              },
              "target": {
                "block": "67455c2b-1187-47e1-9552-af6a75403611",
