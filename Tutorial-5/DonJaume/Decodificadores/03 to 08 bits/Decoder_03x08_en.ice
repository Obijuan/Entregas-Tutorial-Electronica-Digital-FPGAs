{
  "version": "1.1",
  "package": {
    "name": "Decodificador 3 a 8 bits - Enable",
    "version": "0.1",
    "description": "Decodificador 3 a 8 bits con enable",
    "author": "jaume H.",
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "23dd87db-4b39-49c0-a40c-18dc0d532c31",
          "type": "basic.output",
          "data": {
            "name": "out_111",
            "pins": [
        ...
        {
          "id": "bbbe047a-fabf-4375-bfad-3ca55bc7ec2b",
          "type": "basic.output",
          "data": {
            "name": "out_110",
            "pins": [
        ...
        {
          "id": "5051175d-011b-4192-8a45-4c1dfceea58c",
          "type": "basic.output",
          "data": {
            "name": "out_101",
            "pins": [
        ...
        {
          "id": "174da307-3b0f-478b-95a8-2618495c8b66",
          "type": "basic.output",
          "data": {
            "name": "out_100",
            "pins": [
        ...
        {
          "id": "2976e302-b000-4357-a721-47f302234750",
          "type": "basic.output",
          "data": {
            "name": "out_011",
            "pins": [
        ...
        {
          "id": "dcfd8c7e-b6b2-4890-b80c-287c0a0912ce",
          "type": "basic.output",
          "data": {
            "name": "out_010",
            "pins": [
        ...
        {
          "id": "efac3e2a-bc6c-4225-9e20-db417a6d5345",
          "type": "basic.input",
          "data": {
            "name": "en",
            "pins": [
        ...
        {
          "id": "0606d19b-17d8-4c7b-9fe6-fc8fb8d77bf3",
          "type": "basic.output",
          "data": {
            "name": "out_001",
            "pins": [
        ...
        {
          "id": "279116e8-9ba9-4df2-8183-83d46caa6845",
          "type": "basic.output",
          "data": {
            "name": "out_000",
            "pins": [
        ...
        {
          "id": "ddfb851e-e443-4940-9bc4-7cb0d077359e",
          "type": "78cdd31ac6f5296fba524a1f311a43b817d3228e",
          "position": {
            "x": 1040,
            "y": 192
          },
        ...
        {
          "id": "a3bb81ea-37e5-4d18-ac36-ae380aa36d3d",
          "type": "78cdd31ac6f5296fba524a1f311a43b817d3228e",
          "position": {
            "x": 1040,
            "y": 368
        ...
        {
          "id": "e971bf81-8cf1-4ca2-9f87-926e973e9dab",
        ...
        {
          "id": "15a31a08-26a8-417e-975b-4c834d1f8b90",
          "type": "91abf148146a61dd0ce91850f8b25b50d215342c",
          "position": {
            "x": 896,
            "y": 432
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "ddfb851e-e443-4940-9bc4-7cb0d077359e",
        ...
        },
        {
          ...
          "target": {
            "block": "a3bb81ea-37e5-4d18-ac36-ae380aa36d3d",
            "port": "bcc7ba69-872d-4261-b2ed-e30d8e556fab"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "ddfb851e-e443-4940-9bc4-7cb0d077359e",
            "port": "36e293df-8adf-43d1-92ce-ec9d5a2a7bf8"
          },
          "target": {
            "block": "23dd87db-4b39-49c0-a40c-18dc0d532c31",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "ddfb851e-e443-4940-9bc4-7cb0d077359e",
            "port": "e9a0b127-70a7-4403-a83a-60502a504897"
          },
          "target": {
            "block": "bbbe047a-fabf-4375-bfad-3ca55bc7ec2b",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "ddfb851e-e443-4940-9bc4-7cb0d077359e",
            "port": "023f99a9-0f86-4d3a-838d-11354635dab4"
          },
          "target": {
            "block": "5051175d-011b-4192-8a45-4c1dfceea58c",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "ddfb851e-e443-4940-9bc4-7cb0d077359e",
            "port": "8e5e9e7c-e5cb-415e-b7e6-8a98c088fc75"
          },
          "target": {
            "block": "174da307-3b0f-478b-95a8-2618495c8b66",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "2976e302-b000-4357-a721-47f302234750",
            "port": "in"
          }
        },
        {
          ...
          "target": {
            "block": "279116e8-9ba9-4df2-8183-83d46caa6845",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "0606d19b-17d8-4c7b-9fe6-fc8fb8d77bf3",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          ...
          "target": {
            "block": "dcfd8c7e-b6b2-4890-b80c-287c0a0912ce",
            "port": "in"
          },
          "vertices": [
            {
        ...
        {
          "source": {
            "block": "e971bf81-8cf1-4ca2-9f87-926e973e9dab",
        ...
        {
          "source": {
            "block": "15a31a08-26a8-417e-975b-4c834d1f8b90",
            "port": "e23ec09c-c612-4db0-ae91-83a6b9f91044"
          },
          "target": {
            "block": "a3bb81ea-37e5-4d18-ac36-ae380aa36d3d",
        ...
        {
          "source": {
            "block": "efac3e2a-bc6c-4225-9e20-db417a6d5345",
            "port": "out"
          },
          "target": {
            "block": "15a31a08-26a8-417e-975b-4c834d1f8b90",
  ...
  "dependencies": {
    "78cdd31ac6f5296fba524a1f311a43b817d3228e": {
      "package": {
        "name": "Decodificador 2 a 4 bits - enable",
        "version": "0.1",
        "description": "Decodificador 2 a 4 bits con enable",
        "author": "Jaume H.",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "36e293df-8adf-43d1-92ce-ec9d5a2a7bf8",
              "type": "basic.output",
              "data": {
                "name": "out_11"
              },
            ...
            {
              "id": "e9a0b127-70a7-4403-a83a-60502a504897",
              "type": "basic.output",
              "data": {
                "name": "out_10"
              },
            ...
            {
              "id": "023f99a9-0f86-4d3a-838d-11354635dab4",
              "type": "basic.output",
              "data": {
                "name": "out_01"
              },
            ...
            {
              "id": "8e5e9e7c-e5cb-415e-b7e6-8a98c088fc75",
              "type": "basic.output",
              "data": {
                "name": "out_00"
              },
          ...
          "wires": [
            {
              ...
              "target": {
                "block": "36e293df-8adf-43d1-92ce-ec9d5a2a7bf8",
                "port": "in"
              }
            },
            {
              ...
              "target": {
                "block": "e9a0b127-70a7-4403-a83a-60502a504897",
                "port": "in"
              }
            },
            {
              ...
              "target": {
                "block": "023f99a9-0f86-4d3a-838d-11354635dab4",
                "port": "in"
              }
            },
            {
            ...
            },
            {
              ...
              "target": {
                "block": "8e5e9e7c-e5cb-415e-b7e6-8a98c088fc75",
                "port": "in"
              }
            },
            {
